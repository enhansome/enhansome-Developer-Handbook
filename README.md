...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,788 | 🐛 874 | 🌐 C | 📅 2026-09-08 is the friendly OS for IoT
...
[OpenRemote](https://github.com/openremote/openremote) ⭐ 1,894 | 🐛 437 | 🌐 Java | 📅 2026-09-08 is an open source middleware project, which integrates many different protocols and solutions available for smart building, and smart city automation, and offers visualization tools.
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 90,332 | 🐛 3,464 | 🌐 Python | 📅 2026-09-08 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[The Open Source Computer Science Degree by Forrest Knight](https://github.com/ForrestKnight/open-source-cs) ⭐ 23,752 | 🐛 41 | 📅 2025-06-11
...
[Bspwm](https://github.com/baskerville/bspwm) ⭐ 8,313 | 🐛 348 | 🌐 C | 📅 2026-06-19, a tiling window manager based on binary space partitioning with a focus on resource efficiency.
...
[Compute Library](https://github.com/ARM-software/ComputeLibrary) ⭐ 3,189 | 🐛 4 | 🌐 C++ | 📅 2026-09-08 is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,310 | 🐛 215 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,626 | 🐛 340 | 🌐 Python | 📅 2026-09-08 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Airbnb CSS / Sass Style Guide](https://github.com/airbnb/css) ⭐ 6,970 | 🐛 23 | 📅 2024-06-04
...
[axios](https://github.com/axios/axios) ⭐ 109,234 | 🐛 92 | 🌐 JavaScript | 📅 2026-09-08 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 142,220 | 🐛 3,298 | 🌐 JavaScript | 📅 2026-09-08 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,649 | 🐛 633 | 🌐 TypeScript | 📅 2026-09-03 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).

[Enzyme](https://github.com/enzymejs/enzyme) ⭐ 19,815 | 🐛 282 | 🌐 JavaScript | 📅 2025-10-22 is a JavaScript Testing utility for React that makes it easier to test your React Components' output. The user can also manipulate, traverse, and in some ways simulate runtime given the output.

[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,377 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-08 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.

[Redux](https://github.com/reduxjs/redux) ⭐ 61,503 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-08 is a predictable state container for JavaScript apps.
...
[Expo](https://github.com/expo/expo) ⭐ 52,101 | 🐛 808 | 🌐 TypeScript | 📅 2026-09-08 is an open-source platform for making universal native apps with React.
...
[Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript) ⭐ 148,191 | 🐛 162 | 🌐 JavaScript | 📅 2026-04-16
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,480 | 🐛 190 | 🌐 Java | 📅 2026-09-08.
...
[UI-Grid](https://github.com/angular-ui/ui-grid) ⭐ 5,379 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-07 is an AngularJS data grid.
...
[Element](https://github.com/ElemeFE/element) ⭐ 54,050 | 🐛 2,965 | 🌐 Vue | 📅 2024-08-20 is a Vue.js 2.0 UI Toolkit for Web.
...
[node-gyp](https://github.com/nodejs/node-gyp) ⭐ 10,692 | 🐛 172 | 🌐 Python | 📅 2026-09-08 is a cross-platform command-line tool written in Node.js for compiling native addon modules for Node.js. It contains a vendored copy of the gyp-next project that was previously used by the Chromium team, extended to support the development of Node.js native addons.

[nvm ](https://github.com/nvm-sh/nvm) ⭐ 95,032 | 🐛 391 | 🌐 Shell | 📅 2026-09-04 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,905 | 🐛 234 | 🌐 JavaScript | 📅 2026-09-08 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,430 | 🐛 694 | 🌐 TypeScript | 📅 2026-09-08 is a repository for high quality TypeScript type definitions.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,676 | 🐛 1,504 | 🌐 TypeScript | 📅 2026-09-08 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,460 | 🐛 1,664 | 🌐 Rust | 📅 2026-09-08 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,095 | 🐛 437 | 🌐 Rust | 📅 2026-09-08 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,313 | 🐛 244 | 🌐 Rust | 📅 2026-09-08 is a fast and correct HTTP library for Rust.
...
[Servo](https://github.com/servo/servo) ⭐ 37,942 | 🐛 3,209 | 🌐 Rust | 📅 2026-09-08 is a prototype web browser engine written in the Rust language.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,096 | 🐛 34 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
...
[kotlinx-io](https://github.com/Kotlin/kotlinx-io) ⭐ 1,548 | 🐛 109 | 🌐 Kotlin | 📅 2026-08-05 is a multiplatform library for processing binary data, working with memory blocks, interacting with the platform, and performing other low level operations.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,335 | 🐛 9,297 | 🌐 Swift | 📅 2026-09-08
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,191 | 🐛 105 | 🌐 Swift | 📅 2026-09-08 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,424 | 🐛 43 | 🌐 Swift | 📅 2026-09-08 is an HTTP networking library written in Swift.
...
[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,887 | 🐛 2,531 | 🌐 Go | 📅 2026-09-08 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 71,852 | 🐛 378 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,451 | 🐛 1,221 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Rest-assured](https://github.com/rest-assured/rest-assured) ⭐ 7,140 | 🐛 596 | 🌐 Java | 📅 2026-07-22 is a Java DSL for easy testing of REST services.

[Spock](https://github.com/spockframework/spock) ⭐ 3,629 | 🐛 209 | 🌐 Java | 📅 2026-09-08 is a BDD-style developer testing and specification framework for Java and Groovy applications.
...
[Groovy-Eclipse](https://github.com/groovy/groovy-eclipse) ⭐ 682 | 🐛 63 | 🌐 Java | 📅 2026-08-28 is a project that provides Eclipse and Maven tooling support for the Apache Groovy programming language.
...
[clojureVSCode](https://github.com/avli/clojureVSCode) ⭐ 208 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-04 is an extension that provides Clojure and ClojureScript support for Visual Studio Code.

[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,889 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,391 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 interface to [React](https://facebook.github.io/react/).

[Riemann](https://riemann.io/) is a network event stream processing system for monitoring distributed systems, in Clojure.

[Datascript](https://github.com/tonsky/datascript) ⭐ 5,791 | 🐛 76 | 🌐 Clojure | 📅 2026-08-15 is an immutable in-memory database and Datalog query engine in Clojure, ClojureScript, and JavaScript.

[Compojure](https://github.com/weavejester/compojure) ⭐ 4,111 | 🐛 7 | 🌐 Clojure | 📅 2025-09-15 is a small routing library for [Ring](https://github.com/ring-clojure/ring) ⭐ 3,883 | 🐛 41 | 🌐 Clojure | 📅 2026-09-06 that allows web applications to be composed of small, independent parts.

[Ring](https://github.com/ring-clojure/ring) ⭐ 3,883 | 🐛 41 | 🌐 Clojure | 📅 2026-09-06 is a Clojure web applications library inspired by Python's WSGI and Ruby's Rack. By abstracting the details of HTTP into a simple, unified API, Ring allows web applications to be constructed of modular components that can be shared among a variety of applications, web servers, and web frameworks.
...
[Arcadia](https://github.com/arcadia-unity/Arcadia) ⭐ 1,687 | 🐛 55 | 🌐 Clojure | 📅 2023-02-15 is an integration of the Clojure Programming Language with the Unity 3D game engine.
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,123 | 🐛 238 | 🌐 C++ | 📅 2026-09-06 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,619 | 🐛 565 | 🌐 WebAssembly | 📅 2026-09-05 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,619 | 🐛 565 | 🌐 WebAssembly | 📅 2026-09-05 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,004 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-03 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,619 | 🐛 565 | 🌐 WebAssembly | 📅 2026-09-05.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 9,002 | 🐛 357 | 🌐 C | 📅 2026-09-08 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,085 | 🐛 605 | 🌐 C | 📅 2026-09-07 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,767 | 🐛 120 | 🌐 Go | 📅 2026-09-07 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,619 | 🐛 565 | 🌐 WebAssembly | 📅 2026-09-05.
...
[RCall.jl](https://github.com/JuliaInterop/RCall.jl) ⭐ 338 | 🐛 48 | 🌐 Julia | 📅 2026-09-08 is a package that allows you to call R functions from Julia.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,320 | 🐛 768 | 🌐 JavaScript | 📅 2026-09-08.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,777 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-07, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,887 | 🐛 101 | 🌐 Rust | 📅 2026-09-08 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 330 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[.NET for Apache Spark](https://dot.net/spark) provides high performance APIs for using Apache Spark from C# and F#. With these .NET APIs, you can access the most popular Dataframe and SparkSQL aspects of Apache Spark, for working with structured data, and Spark Structured Streaming, for working with streaming data. .NET for Apache Spark runs on Windows, Linux, and macOS using .NET Core, or Windows using .NET Framework. It also runs on all major cloud providers including [Azure HDInsight Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#azure-hdinsight-spark) ⭐ 2,096 | 🐛 195 | 🌐 C# | 📅 2026-09-08, [Amazon EMR Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#amazon-emr-spark) ⭐ 2,096 | 🐛 195 | 🌐 C# | 📅 2026-09-08, [AWS](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,096 | 🐛 195 | 🌐 C# | 📅 2026-09-08 & [Azure](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,096 | 🐛 195 | 🌐 C# | 📅 2026-09-08 Databricks.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,255 | 🐛 7,758 | 🌐 C# | 📅 2026-09-08 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[Polly](https://github.com/App-vNext/Polly) ⭐ 14,237 | 🐛 4 | 🌐 C# | 📅 2026-09-08 is a .NET resilience and transient-fault-handling library that allows developers to express policies such as Retry, Circuit Breaker, Timeout, Bulkhead Isolation, and Fallback in a fluent and thread-safe manner.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,032 | 🐛 173 | 🌐 C# | 📅 2026-09-08 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,319 | 🐛 3,905 | 🌐 C# | 📅 2026-09-08 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,276 | 🐛 8,439 | 🌐 Dart | 📅 2026-09-08 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,659 | 🐛 445 | 🌐 C++ | 📅 2026-09-08 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-08 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.

[React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-07 is Redux bindings for Firebase that includes React Hooks and Higher Order Components.

[FirebaseUI](https://github.com/firebase/FirebaseUI-Android) ⭐ 4,805 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-08 is an open-source library for Android that allows you to quickly connect common UI elements to Firebase APIs.

[Pyrebase](https://github.com/thisbejim/Pyrebase) ⭐ 2,071 | 🐛 237 | 🌐 Python | 📅 2024-05-14 is a  simple python wrapper for the Firebase API.
...
[Infer](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 203 | 🌐 OCaml | 📅 2026-09-03 is a static analysis tool for Java, C++, Objective-C, and C.
...
[npTDMS](https://github.com/adamreeve/npTDMS) ⭐ 273 | 🐛 20 | 🌐 Python | 📅 2026-08-31 is a cross-platform Python package for reading and writing TDMS files as produced by LabVIEW, and is built on top of the [numpy](https://www.numpy.org/) package.

[Featherweight](https://github.com/featherweight/featherweight) ⭐ 33 | 🐛 63 | 🌐 C | 📅 2017-04-20 is an Application Framework for NI LabVIEW™.

[LV-MQTT-Broker](https://github.com/LabVIEW-Open-Source/LV-MQTT-Broker) ⭐ 55 | 🐛 83 | 🌐 LabVIEW | 📅 2024-01-14 is the native LabVIEW MQTT Broker Server.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,678 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-07 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,577 | 🐛 180 | 🌐 TypeScript | 📅 2026-09-08 v4 and React Bootstrap.
...
[Absinthe](https://github.com/absinthe-graphql/absinthe) ⭐ 4,402 | 🐛 68 | 🌐 Elixir | 📅 2026-09-02 is a GraphQL toolkit for Elixir.
...
[Floki](https://github.com/philss/floki) ⭐ 2,148 | 🐛 24 | 🌐 Elixir | 📅 2026-06-16 is a simple HTML parser that enables search for nodes using CSS selectors.

[Timex](https://github.com/bitwalker/timex) ⭐ 1,806 | 🐛 71 | 🌐 Elixir | 📅 2025-06-14 is a complete date/time library for Elixir projects.
...
[Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,527 | 🐛 65 | 🌐 Erlang | 📅 2026-09-08 is a small, fast and modern HTTP server for Erlang/OTP.
...
[Tsung](https://github.com/processone/tsung) ⭐ 2,627 | 🐛 130 | 🌐 Erlang | 📅 2026-03-02 is a high-performance benchmark framework for various protocols including HTTP, XMPP, LDAP, etc.
...
[Sequeler](https://github.com/Alecaddd/sequeler) ⭐ 841 | 🐛 68 | 🌐 Vala | 📅 2026-09-07 is a native Linux SQL client built in Vala and Gtk. It allows you to connect to your local and remote databases, write SQL in a handy text editor with language recognition, and visualize SELECT results in a Gtk.Grid Widget.

[Code](https://github.com/elementary/code) ⭐ 519 | 🐛 153 | 🌐 Vala | 📅 2026-09-07 is a fast and lightweight code editor designed for elementary OS.

[Granite](https://github.com/elementary/granite) ⭐ 324 | 🐛 133 | 🌐 Vala | 📅 2026-09-08 is a companion library for GTK+ and GLib. Also, it provides complex widgets and convenience functions designed for use in apps built for elementary OS.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,392 | 🐛 206 | 🌐 Haskell | 📅 2026-08-24 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 597 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-07 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,954 | 🐛 567 | 🌐 Haskell | 📅 2026-09-07.
...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,554 | 🐛 134 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,843 | 🐛 1,759 | 🌐 C++ | 📅 2026-09-08 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more.

[PowerShell Core](https://github.com/PowerShell/PowerShell) ⭐ 55,299 | 🐛 1,622 | 🌐 C# | 📅 2026-09-08 is a cross-platform (Windows, Linux, and macOS) automation and configuration tool/framework that works well with your existing tools and is optimized for dealing with structured data (e.g. JSON, CSV, XML, etc.), REST APIs, and object models. It includes a command-line shell, an associated scripting language and a framework for processing cmdlets.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,480 | 🐛 1,002 | 🌐 C++ | 📅 2026-09-08 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,838 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,716 | 🐛 660 | 🌐 TypeScript | 📅 2026-06-18 is a library which was made for and is used by ethers.io. It is designed to make it easier to write client-side JavaScript based wallets, keeping the private key on the owner’s machine at all times.
...
[Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,407 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 is a graphical processor simulator and assembly editor for the RISC-V instruction set architecture(ISA).

[FireSim](https://github.com/firesim/firesim) ⭐ 1,040 | 🐛 239 | 🌐 Scala | 📅 2026-09-04 is an easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
[Reko](https://github.com/uxmal/reko) ⭐ 2,601 | 🐛 165 | 🌐 C# | 📅 2026-09-07 is a decompiler for machine code binaries.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,732 | 🐛 529 | 🌐 Python | 📅 2026-09-08 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 44,104 | 🐛 194 | 🌐 Lua | 📅 2026-09-07 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,113 | 🐛 156 | 🌐 Go | 📅 2026-09-03 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,620 | 🐛 103 | 🌐 Rust | 📅 2026-09-08 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,502 | 🐛 6,934 | 🌐 Go | 📅 2026-09-08 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.

[Prisma](https://www.prisma.io) is open source ORM for Node.js, TypeScript, PostgreSQL, MySQL and SQLite.

[Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,817 | 🐛 687 | 🌐 Python | 📅 2023-03-23 is a tool for Serverless Python.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,505 | 🐛 256 | 🌐 Go | 📅 2026-09-08 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,740 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-07 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,792 | 🐛 1,174 | 🌐 Rust | 📅 2026-09-08 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,006 | 🐛 42 | 🌐 Python | 📅 2026-09-08 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,056 | 🐛 107 | 🌐 Python | 📅 2026-09-08 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.
...
[OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,733 | 🐛 31 | 🌐 Python | 📅 2026-09-07 is an open source library for compiling and analyzing quantum algorithms to simulate fermionic systems, including quantum chemistry.
