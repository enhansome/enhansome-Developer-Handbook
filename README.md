...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,782 | 🐛 872 | 🌐 C | 📅 2026-09-01 is the friendly OS for IoT
...
[OpenRemote](https://github.com/openremote/openremote) ⭐ 1,889 | 🐛 435 | 🌐 Java | 📅 2026-09-01 is an open source middleware project, which integrates many different protocols and solutions available for smart building, and smart city automation, and offers visualization tools.
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 90,210 | 🐛 3,375 | 🌐 Python | 📅 2026-09-01 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[The Open Source Computer Science Degree by Forrest Knight](https://github.com/ForrestKnight/open-source-cs) ⭐ 23,747 | 🐛 41 | 📅 2025-06-11
...
[Bspwm](https://github.com/baskerville/bspwm) ⭐ 8,309 | 🐛 348 | 🌐 C | 📅 2026-06-19, a tiling window manager based on binary space partitioning with a focus on resource efficiency.
...
[Compute Library](https://github.com/ARM-software/ComputeLibrary) ⭐ 3,187 | 🐛 3 | 🌐 C++ | 📅 2026-09-01 is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,287 | 🐛 215 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,118 | 🐛 46 | 🌐 Python | 📅 2026-09-01 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.
...
[Airbnb CSS / Sass Style Guide](https://github.com/airbnb/css) ⭐ 6,973 | 🐛 23 | 📅 2024-06-04
...
[axios](https://github.com/axios/axios) ⭐ 109,197 | 🐛 87 | 🌐 JavaScript | 📅 2026-09-01 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 142,064 | 🐛 3,517 | 🌐 JavaScript | 📅 2026-09-01 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,643 | 🐛 619 | 🌐 TypeScript | 📅 2026-09-01 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).

[Enzyme](https://github.com/enzymejs/enzyme) ⭐ 19,818 | 🐛 282 | 🌐 JavaScript | 📅 2025-10-22 is a JavaScript Testing utility for React that makes it easier to test your React Components' output. The user can also manipulate, traverse, and in some ways simulate runtime given the output.

[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,372 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-01 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.

[Redux](https://github.com/reduxjs/redux) ⭐ 61,510 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-20 is a predictable state container for JavaScript apps.
...
[Expo](https://github.com/expo/expo) ⭐ 51,958 | 🐛 757 | 🌐 TypeScript | 📅 2026-09-01 is an open-source platform for making universal native apps with React.
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,446 | 🐛 191 | 🌐 Java | 📅 2026-09-01.
...
[UI-Grid](https://github.com/angular-ui/ui-grid) ⭐ 5,376 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26 is an AngularJS data grid.
...
[Element](https://github.com/ElemeFE/element) ⭐ 54,058 | 🐛 2,964 | 🌐 Vue | 📅 2024-08-20 is a Vue.js 2.0 UI Toolkit for Web.
...
[nvm ](https://github.com/nvm-sh/nvm) ⭐ 94,805 | 🐛 397 | 🌐 Shell | 📅 2026-08-18 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,906 | 🐛 266 | 🌐 JavaScript | 📅 2026-09-01 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,419 | 🐛 687 | 🌐 TypeScript | 📅 2026-09-01 is a repository for high quality TypeScript type definitions.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,617 | 🐛 559 | 🌐 WebAssembly | 📅 2026-09-01.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,668 | 🐛 1,505 | 🌐 TypeScript | 📅 2026-09-01 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,445 | 🐛 1,654 | 🌐 Rust | 📅 2026-09-01 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,048 | 🐛 449 | 🌐 Rust | 📅 2026-08-31 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,299 | 🐛 244 | 🌐 Rust | 📅 2026-08-31 is a fast and correct HTTP library for Rust.
...
[Servo](https://github.com/servo/servo) ⭐ 37,868 | 🐛 3,179 | 🌐 Rust | 📅 2026-09-01 is a prototype web browser engine written in the Rust language.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,022 | 🐛 33 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
...
[kotlinx-lincheck](https://github.com/Kotlin/kotlinx-lincheck) ⭐ 693 | 🐛 97 | 🌐 Kotlin | 📅 2026-08-30 is a framework for testing concurrent data structures for correctness.

[kotlinx-io](https://github.com/Kotlin/kotlinx-io) ⭐ 1,548 | 🐛 107 | 🌐 Kotlin | 📅 2026-08-05 is a multiplatform library for processing binary data, working with memory blocks, interacting with the platform, and performing other low level operations.

[kotlinx-knit](https://github.com/Kotlin/kotlinx-knit) ⭐ 318 | 🐛 17 | 🌐 Kotlin | 📅 2026-04-30 is a tool that produces Kotlin source example files and tests from markdown documents with embedded snippets of Kotlin code. It also helps to add links to the API documentation website into the documents and has a few other helpful markdown-management features.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,869 | 🐛 88 | 🌐 Markdown | 📅 2026-08-31 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,313 | 🐛 9,247 | 🌐 Swift | 📅 2026-09-01
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,193 | 🐛 121 | 🌐 Swift | 📅 2026-09-01 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,701 | 🐛 909 | 🌐 Go | 📅 2026-09-01 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.
...
[Gravitational Teleport](https://github.com/gravitational/teleport) ⭐ 20,873 | 🐛 3,323 | 🌐 Go | 📅 2026-09-01 is a modern security gateway for remotely accessing into Clusters of Linux servers via SSH or SSH-over-HTTPS in a browser or Kubernetes clusters.
...
[Fiber](https://gofiber.io/) is an [Express](https://github.com/expressjs/express) ⭐ 69,419 | 🐛 232 | 🌐 JavaScript | 📅 2026-09-01 inspired web framework built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,456 | 🐛 88 | 🌐 Go | 📅 2026-08-31, the fastest HTTP engine for Go. Designed to ease things up for fast development with zero memory allocation and performance in mind.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,420 | 🐛 1,185 | 🌐 CMake | 📅 2026-08-31 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spock](https://github.com/spockframework/spock) ⭐ 3,631 | 🐛 208 | 🌐 Java | 📅 2026-08-26 is a BDD-style developer testing and specification framework for Java and Groovy applications.
...
[Groovy-Eclipse](https://github.com/groovy/groovy-eclipse) ⭐ 681 | 🐛 62 | 🌐 Java | 📅 2026-08-28 is a project that provides Eclipse and Maven tooling support for the Apache Groovy programming language.
...
[clojureVSCode](https://github.com/avli/clojureVSCode) ⭐ 207 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-05 is an extension that provides Clojure and ClojureScript support for Visual Studio Code.

[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,888 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,391 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 interface to [React](https://facebook.github.io/react/).

[Riemann](https://riemann.io/) is a network event stream processing system for monitoring distributed systems, in Clojure.

[Datascript](https://github.com/tonsky/datascript) ⭐ 5,787 | 🐛 76 | 🌐 Clojure | 📅 2026-08-15 is an immutable in-memory database and Datalog query engine in Clojure, ClojureScript, and JavaScript.

[Compojure](https://github.com/weavejester/compojure) ⭐ 4,112 | 🐛 7 | 🌐 Clojure | 📅 2025-09-15 is a small routing library for [Ring](https://github.com/ring-clojure/ring) ⭐ 3,884 | 🐛 41 | 🌐 Clojure | 📅 2026-06-23 that allows web applications to be composed of small, independent parts.

[Ring](https://github.com/ring-clojure/ring) ⭐ 3,884 | 🐛 41 | 🌐 Clojure | 📅 2026-06-23 is a Clojure web applications library inspired by Python's WSGI and Ruby's Rack. By abstracting the details of HTTP into a simple, unified API, Ring allows web applications to be constructed of modular components that can be shared among a variety of applications, web servers, and web frameworks.

[Hiccup](https://github.com/weavejester/hiccup) ⭐ 2,856 | 🐛 25 | 🌐 Clojure | 📅 2025-06-19 is a library for representing HTML in Clojure. It uses vectors to represent elements, and maps to represent an element's attributes.
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,111 | 🐛 231 | 🌐 C++ | 📅 2026-08-30 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,617 | 🐛 559 | 🌐 WebAssembly | 📅 2026-09-01 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,617 | 🐛 559 | 🌐 WebAssembly | 📅 2026-09-01 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,998 | 🐛 201 | 🌐 WebAssembly | 📅 2026-07-22 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,617 | 🐛 559 | 🌐 WebAssembly | 📅 2026-09-01.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 8,993 | 🐛 366 | 🌐 C | 📅 2026-09-01 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,084 | 🐛 603 | 🌐 C | 📅 2026-09-01 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,749 | 🐛 119 | 🌐 Go | 📅 2026-09-01 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,617 | 🐛 559 | 🌐 WebAssembly | 📅 2026-09-01.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,776 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-01, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,823 | 🐛 97 | 🌐 Rust | 📅 2026-09-01 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 327 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[.NET for Apache Spark](https://dot.net/spark) provides high performance APIs for using Apache Spark from C# and F#. With these .NET APIs, you can access the most popular Dataframe and SparkSQL aspects of Apache Spark, for working with structured data, and Spark Structured Streaming, for working with streaming data. .NET for Apache Spark runs on Windows, Linux, and macOS using .NET Core, or Windows using .NET Framework. It also runs on all major cloud providers including [Azure HDInsight Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#azure-hdinsight-spark) ⭐ 2,096 | 🐛 201 | 🌐 C# | 📅 2026-09-01, [Amazon EMR Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#amazon-emr-spark) ⭐ 2,096 | 🐛 201 | 🌐 C# | 📅 2026-09-01, [AWS](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,096 | 🐛 201 | 🌐 C# | 📅 2026-09-01 & [Azure](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,096 | 🐛 201 | 🌐 C# | 📅 2026-09-01 Databricks.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,243 | 🐛 7,671 | 🌐 C# | 📅 2026-09-01 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,992 | 🐛 179 | 🌐 C# | 📅 2026-09-01 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,316 | 🐛 3,836 | 🌐 C# | 📅 2026-09-01 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,267 | 🐛 8,437 | 🌐 Dart | 📅 2026-09-01 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,742 | 🐛 13,155 | 🌐 Dart | 📅 2026-09-01
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-09-01 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,742 | 🐛 13,155 | 🌐 Dart | 📅 2026-09-01 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,691 | 🐛 22 | 🌐 C | 📅 2026-08-23 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,658 | 🐛 444 | 🌐 C++ | 📅 2026-09-01 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-01 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.

[React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-01 is Redux bindings for Firebase that includes React Hooks and Higher Order Components.

[FirebaseUI](https://github.com/firebase/FirebaseUI-Android) ⭐ 4,805 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-01 is an open-source library for Android that allows you to quickly connect common UI elements to Firebase APIs.
...
[ReactFire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-25 is a project that provides Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
[Infer](https://github.com/facebook/infer) ⭐ 15,700 | 🐛 204 | 🌐 OCaml | 📅 2026-09-01 is a static analysis tool for Java, C++, Objective-C, and C.
...
[Qaterial](https://github.com/OlivierLDff/Qaterial) ⭐ 361 | 🐛 28 | 🌐 QML | 📅 2026-05-03 is a collection of Material Components to build faster UI using Qml.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,679 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-28 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,576 | 🐛 172 | 🌐 TypeScript | 📅 2026-08-28 v4 and React Bootstrap.
...
[Elixir Style Guide](https://github.com/christopheradams/elixir_style_guide) ⭐ 4,426 | 🐛 8 | 🌐 Elixir | 📅 2024-05-10
...
[CubDB](https://github.com/lucaong/cubdb) ⭐ 654 | 🐛 15 | 🌐 Elixir | 📅 2024-10-02 is an embedded key-value database written in the Elixir language. It runs locally, it is schema-less, and backed by a single file.
...
[Absinthe](https://github.com/absinthe-graphql/absinthe) ⭐ 4,401 | 🐛 73 | 🌐 Elixir | 📅 2026-07-14 is a GraphQL toolkit for Elixir.
...
[Timex](https://github.com/bitwalker/timex) ⭐ 1,807 | 🐛 70 | 🌐 Elixir | 📅 2025-06-14 is a complete date/time library for Elixir projects.
...
[Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,524 | 🐛 65 | 🌐 Erlang | 📅 2026-08-25 is a small, fast and modern HTTP server for Erlang/OTP.
...
[Tsung](https://github.com/processone/tsung) ⭐ 2,629 | 🐛 130 | 🌐 Erlang | 📅 2026-03-02 is a high-performance benchmark framework for various protocols including HTTP, XMPP, LDAP, etc.
...
[Hackney](https://github.com/benoitc/hackney) ⭐ 1,417 | 🐛 16 | 🌐 Erlang | 📅 2026-08-31 is a simple HTTP client in Erlang.
...
[Lua Language Server](https://github.com/sumneko/lua-language-server) ⭐ 4,357 | 🐛 706 | 🌐 Lua | 📅 2026-09-01 is an extension for VSCode that provides support for the Lua Language Server.

[Apache APISIX](https://github.com/apache/apisix) ⭐ 17,068 | 🐛 240 | 🌐 Lua | 📅 2026-09-01 is a dynamic, real-time, high-performance API gateway, based on the Nginx library and etcd.
...
[Sequeler](https://github.com/Alecaddd/sequeler) ⭐ 841 | 🐛 68 | 🌐 Vala | 📅 2026-07-03 is a native Linux SQL client built in Vala and Gtk. It allows you to connect to your local and remote databases, write SQL in a handy text editor with language recognition, and visualize SELECT results in a Gtk.Grid Widget.

[Code](https://github.com/elementary/code) ⭐ 520 | 🐛 153 | 🌐 Vala | 📅 2026-09-01 is a fast and lightweight code editor designed for elementary OS.

[Granite](https://github.com/elementary/granite) ⭐ 324 | 🐛 133 | 🌐 Vala | 📅 2026-09-01 is a companion library for GTK+ and GLib. Also, it provides complex widgets and convenience functions designed for use in apps built for elementary OS.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,378 | 🐛 203 | 🌐 Haskell | 📅 2026-08-24 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 596 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-11 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,955 | 🐛 558 | 🌐 Haskell | 📅 2026-08-31.
...
[CodeWorld](https://github.com/google/codeworld) ⭐ 1,270 | 🐛 315 | 🌐 Haskell | 📅 2026-01-25 is an educational environment using Haskell. It provides a simple mathematical model for geometric figures, animations, and interactive and multi-player games.
...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,775 | 🐛 1,762 | 🌐 C++ | 📅 2026-09-01 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more.

[PowerShell Core](https://github.com/PowerShell/PowerShell) ⭐ 55,215 | 🐛 1,608 | 🌐 C# | 📅 2026-09-01 is a cross-platform (Windows, Linux, and macOS) automation and configuration tool/framework that works well with your existing tools and is optimized for dealing with structured data (e.g. JSON, CSV, XML, etc.), REST APIs, and object models. It includes a command-line shell, an associated scripting language and a framework for processing cmdlets.
...
[Pengwin](https://github.com/WhitewaterFoundry/Pengwin) ⭐ 1,519 | 🐛 92 | 🌐 C++ | 📅 2026-02-13 is a Linux distro optimized for WSL based on Debian.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,465 | 🐛 1,005 | 🌐 C++ | 📅 2026-08-27 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,740 | 🐛 47 | 🌐 Python | 📅 2026-08-15 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,717 | 🐛 660 | 🌐 TypeScript | 📅 2026-06-18 is a library which was made for and is used by ethers.io. It is designed to make it easier to write client-side JavaScript based wallets, keeping the private key on the owner’s machine at all times.
...
[UniversalSoundboard](https://github.com/dav-apps/UniversalSoundboard) ⭐ 18 | 🐛 8 | 🌐 C# | 📅 2026-08-29 is a customizable soundboard for your Windows 10 device. Add your sounds or music and sort them in categories. You can also add images to your favourite sounds.
...
[Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,400 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 is a graphical processor simulator and assembly editor for the RISC-V instruction set architecture(ISA).

[FireSim](https://github.com/firesim/firesim) ⭐ 1,038 | 🐛 239 | 🌐 Scala | 📅 2026-08-31 is an easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
[DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,602 | 🐛 5 | 🌐 Verilog | 📅 2026-08-30 is an open souce RISC-V cpu core implemented in Verilog from scratch.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,732 | 🐛 540 | 🌐 Python | 📅 2026-09-01 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 44,071 | 🐛 193 | 🌐 Lua | 📅 2026-08-16 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,108 | 🐛 156 | 🌐 Go | 📅 2026-08-13 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,426 | 🐛 113 | 🌐 Rust | 📅 2026-09-01 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.

[Gloo Edge](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,873 | 🌐 Go | 📅 2026-09-01 is a feature-rich, Kubernetes-native ingress controller, and next-generation API gateway built on [Envoy](https://envoy.com/features/saas/).
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,480 | 🐛 6,861 | 🌐 Go | 📅 2026-09-01 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.

[Prisma](https://www.prisma.io) is open source ORM for Node.js, TypeScript, PostgreSQL, MySQL and SQLite.

[Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,823 | 🐛 687 | 🌐 Python | 📅 2023-03-23 is a tool for Serverless Python.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,480 | 🐛 250 | 🌐 Go | 📅 2026-09-01 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,743 | 🐛 113 | 🌐 TypeScript | 📅 2026-08-30 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,752 | 🐛 1,150 | 🌐 Rust | 📅 2026-09-01 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,057 | 🐛 108 | 🌐 Python | 📅 2026-09-01 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.

[PyQuil](https://github.com/rigetti/pyquil) ⭐ 1,498 | 🐛 242 | 🌐 Python | 📅 2026-08-20 is a Python library for quantum programming using [Quil](https://arxiv.org/abs/1608.03355), the quantum instruction language developed at [Rigetti Computing](https://www.rigetti.com/).

[OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,731 | 🐛 30 | 🌐 Python | 📅 2026-09-01 is an open source library for compiling and analyzing quantum algorithms to simulate fermionic systems, including quantum chemistry.

[QuTiP](https://github.com/qutip/qutip) ⭐ 2,065 | 🐛 115 | 🌐 Python | 📅 2026-08-31 is open-source software for simulating the dynamics of closed and open quantum systems. The QuTiP library uses the excellent Numpy, Scipy, and Cython packages as the numerical backend, and graphical output is provided by Matplotlib.
