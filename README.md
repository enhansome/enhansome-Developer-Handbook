...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,800 | 🐛 874 | 🌐 C | 📅 2026-09-14 is the friendly OS for IoT
...
[OpenRemote](https://github.com/openremote/openremote) ⭐ 1,903 | 🐛 435 | 🌐 Java | 📅 2026-09-14 is an open source middleware project, which integrates many different protocols and solutions available for smart building, and smart city automation, and offers visualization tools.
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 90,448 | 🐛 3,551 | 🌐 Python | 📅 2026-09-14 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[The Open Source Computer Science Degree by Forrest Knight](https://github.com/ForrestKnight/open-source-cs) ⭐ 23,755 | 🐛 41 | 📅 2025-06-11
...
[Bspwm](https://github.com/baskerville/bspwm) ⭐ 8,315 | 🐛 348 | 🌐 C | 📅 2026-06-19, a tiling window manager based on binary space partitioning with a focus on resource efficiency.
...
[Compute Library](https://github.com/ARM-software/ComputeLibrary) ⭐ 3,192 | 🐛 10 | 🌐 C++ | 📅 2026-09-09 is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,335 | 🐛 216 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[axios](https://github.com/axios/axios) ⭐ 109,212 | 🐛 91 | 🌐 JavaScript | 📅 2026-09-13 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 142,308 | 🐛 3,361 | 🌐 JavaScript | 📅 2026-09-14 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,377 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.

[Redux](https://github.com/reduxjs/redux) ⭐ 61,486 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-08 is a predictable state container for JavaScript apps.
...
[Expo](https://github.com/expo/expo) ⭐ 52,238 | 🐛 853 | 🌐 TypeScript | 📅 2026-09-14 is an open-source platform for making universal native apps with React.
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,490 | 🐛 188 | 🌐 Java | 📅 2026-09-14.
...
[UI-Grid](https://github.com/angular-ui/ui-grid) ⭐ 5,382 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 is an AngularJS data grid.
...
[Element](https://github.com/ElemeFE/element) ⭐ 54,044 | 🐛 2,965 | 🌐 Vue | 📅 2024-08-20 is a Vue.js 2.0 UI Toolkit for Web.
...
[The Node.js best practices list ](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,615 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15
...
[nvm ](https://github.com/nvm-sh/nvm) ⭐ 95,081 | 🐛 389 | 🌐 Shell | 📅 2026-09-11 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,438 | 🐛 694 | 🌐 TypeScript | 📅 2026-09-14 is a repository for high quality TypeScript type definitions.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,624 | 🐛 564 | 🌐 WebAssembly | 📅 2026-09-14.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,690 | 🐛 1,506 | 🌐 TypeScript | 📅 2026-09-14 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,477 | 🐛 1,669 | 🌐 Rust | 📅 2026-09-14 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,149 | 🐛 443 | 🌐 Rust | 📅 2026-09-14 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,842 | 🐛 1,814 | 🌐 Rust | 📅 2026-09-14 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,316 | 🐛 244 | 🌐 Rust | 📅 2026-09-13 is a fast and correct HTTP library for Rust.
...
[Servo](https://github.com/servo/servo) ⭐ 37,974 | 🐛 3,198 | 🌐 Rust | 📅 2026-09-14 is a prototype web browser engine written in the Rust language.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,142 | 🐛 35 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
...
[Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,673 | 🐛 205 | 🌐 Rust | 📅 2026-09-09 is an open-source Linux-based operating system meant for hosting containers. Bottlerocket focuses on security and maintainability, providing a reliable, consistent, and safe platform for container-based workloads.
...
[kotlinx-lincheck](https://github.com/Kotlin/kotlinx-lincheck) ⭐ 694 | 🐛 98 | 🌐 Kotlin | 📅 2026-08-30 is a framework for testing concurrent data structures for correctness.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,872 | 🐛 93 | 🌐 Markdown | 📅 2026-09-14 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,348 | 🐛 9,328 | 🌐 Swift | 📅 2026-09-14
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,187 | 🐛 85 | 🌐 Swift | 📅 2026-09-14 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,392 | 🐛 173 | 🌐 Swift | 📅 2026-09-13 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Gravitational Teleport](https://github.com/gravitational/teleport) ⭐ 20,918 | 🐛 3,263 | 🌐 Go | 📅 2026-09-11 is a modern security gateway for remotely accessing into Clusters of Linux servers via SSH or SSH-over-HTTPS in a browser or Kubernetes clusters.
...
[Act](https://github.com/nektos/act) ⭐ 72,002 | 🐛 380 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,461 | 🐛 1,145 | 🌐 CMake | 📅 2026-09-11 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[rbenv](https://github.com/rbenv/rbenv) ⭐ 16,731 | 🐛 17 | 🌐 Shell | 📅 2026-07-14 allows to pick a Ruby version for your application and guarantee that your development environment matches production. Put rbenv to work with Bundler for painless Ruby upgrades and bulletproof deployments.
...
[Rest-assured](https://github.com/rest-assured/rest-assured) ⭐ 7,139 | 🐛 597 | 🌐 Java | 📅 2026-07-22 is a Java DSL for easy testing of REST services.

[Spock](https://github.com/spockframework/spock) ⭐ 3,630 | 🐛 209 | 🌐 Java | 📅 2026-09-12 is a BDD-style developer testing and specification framework for Java and Groovy applications.
...
[Groovy-Eclipse](https://github.com/groovy/groovy-eclipse) ⭐ 682 | 🐛 65 | 🌐 Java | 📅 2026-09-14 is a project that provides Eclipse and Maven tooling support for the Apache Groovy programming language.
...
[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,889 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,392 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 interface to [React](https://facebook.github.io/react/).
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,129 | 🐛 238 | 🌐 C++ | 📅 2026-09-14 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,624 | 🐛 564 | 🌐 WebAssembly | 📅 2026-09-14 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,624 | 🐛 564 | 🌐 WebAssembly | 📅 2026-09-14 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,015 | 🐛 204 | 🌐 WebAssembly | 📅 2026-09-14 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,624 | 🐛 564 | 🌐 WebAssembly | 📅 2026-09-14.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 9,021 | 🐛 358 | 🌐 C | 📅 2026-09-10 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,090 | 🐛 601 | 🌐 C | 📅 2026-09-14 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,777 | 🐛 123 | 🌐 Go | 📅 2026-09-14 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,624 | 🐛 564 | 🌐 WebAssembly | 📅 2026-09-14.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,205 | 🐛 112 | 🌐 Julia | 📅 2026-09-14 is a univariate and multivariate optimization in Julia.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,329 | 🐛 771 | 🌐 JavaScript | 📅 2026-09-14.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,778 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-14, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,947 | 🐛 105 | 🌐 Rust | 📅 2026-09-14 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 329 | 🐛 77 | 🌐 C | 📅 2026-09-13 and supports [explainshell](https://explainshell.com/) integration.
...
[.NET for Apache Spark](https://dot.net/spark) provides high performance APIs for using Apache Spark from C# and F#. With these .NET APIs, you can access the most popular Dataframe and SparkSQL aspects of Apache Spark, for working with structured data, and Spark Structured Streaming, for working with streaming data. .NET for Apache Spark runs on Windows, Linux, and macOS using .NET Core, or Windows using .NET Framework. It also runs on all major cloud providers including [Azure HDInsight Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#azure-hdinsight-spark) ⭐ 2,096 | 🐛 211 | 🌐 C# | 📅 2026-09-11, [Amazon EMR Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#amazon-emr-spark) ⭐ 2,096 | 🐛 211 | 🌐 C# | 📅 2026-09-11, [AWS](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,096 | 🐛 211 | 🌐 C# | 📅 2026-09-11 & [Azure](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,096 | 🐛 211 | 🌐 C# | 📅 2026-09-11 Databricks.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,273 | 🐛 7,861 | 🌐 C# | 📅 2026-09-14 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,065 | 🐛 177 | 🌐 C# | 📅 2026-09-14 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,319 | 🐛 3,901 | 🌐 C# | 📅 2026-09-14 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,281 | 🐛 8,411 | 🌐 Dart | 📅 2026-09-14 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,943 | 🐛 13,175 | 🌐 Dart | 📅 2026-09-14
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,657 | 🐛 447 | 🌐 C++ | 📅 2026-09-14 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,306 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-14 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.

[React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-10 is Redux bindings for Firebase that includes React Hooks and Higher Order Components.

[FirebaseUI](https://github.com/firebase/FirebaseUI-Android) ⭐ 4,804 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-14 is an open-source library for Android that allows you to quickly connect common UI elements to Firebase APIs.
...
[ReactFire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,570 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-11 is a project that provides Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,105 | 🐛 692 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,676 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-10 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,574 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-14 v4 and React Bootstrap.
...
[CubDB](https://github.com/lucaong/cubdb) ⭐ 655 | 🐛 16 | 🌐 Elixir | 📅 2024-10-02 is an embedded key-value database written in the Elixir language. It runs locally, it is schema-less, and backed by a single file.
...
[Credo](https://github.com/rrrene/credo) ⭐ 5,220 | 🐛 40 | 🌐 Elixir | 📅 2026-08-26 is a static code analysis tool for the Elixir language with a focus on code consistency and teaching.
...
[Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,524 | 🐛 65 | 🌐 Erlang | 📅 2026-09-08 is a small, fast and modern HTTP server for Erlang/OTP.
...
[Apache APISIX](https://github.com/apache/apisix) ⭐ 17,120 | 🐛 242 | 🌐 Lua | 📅 2026-09-14 is a dynamic, real-time, high-performance API gateway, based on the Nginx library and etcd.
...
[GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,981 | 🐛 104 | 🌐 Go | 📅 2026-04-01 is a Lua 5.1 VM and compiler written in Go.
...
[Sequeler](https://github.com/Alecaddd/sequeler) ⭐ 842 | 🐛 67 | 🌐 Vala | 📅 2026-09-07 is a native Linux SQL client built in Vala and Gtk. It allows you to connect to your local and remote databases, write SQL in a handy text editor with language recognition, and visualize SELECT results in a Gtk.Grid Widget.

[Code](https://github.com/elementary/code) ⭐ 521 | 🐛 152 | 🌐 Vala | 📅 2026-09-11 is a fast and lightweight code editor designed for elementary OS.

[Granite](https://github.com/elementary/granite) ⭐ 329 | 🐛 137 | 🌐 Vala | 📅 2026-09-14 is a companion library for GTK+ and GLib. Also, it provides complex widgets and convenience functions designed for use in apps built for elementary OS.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,402 | 🐛 208 | 🌐 Haskell | 📅 2026-08-24 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 597 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-13 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,955 | 🐛 565 | 🌐 Haskell | 📅 2026-09-12.
...
[CodeWorld](https://github.com/google/codeworld) ⭐ 1,270 | 🐛 313 | 🌐 Haskell | 📅 2026-01-25 is an educational environment using Haskell. It provides a simple mathematical model for geometric figures, animations, and interactive and multi-player games.
...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,894 | 🐛 1,753 | 🌐 C++ | 📅 2026-09-14 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more.

[PowerShell Core](https://github.com/PowerShell/PowerShell) ⭐ 55,385 | 🐛 1,630 | 🌐 C# | 📅 2026-09-11 is a cross-platform (Windows, Linux, and macOS) automation and configuration tool/framework that works well with your existing tools and is optimized for dealing with structured data (e.g. JSON, CSV, XML, etc.), REST APIs, and object models. It includes a command-line shell, an associated scripting language and a framework for processing cmdlets.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,936 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[LibGDX](https://github.com/libgdx/libgdx) ⭐ 25,391 | 🐛 337 | 🌐 Java | 📅 2026-09-09 is a cross-platform Java game development framework based on OpenGL (ES) that works on Windows, Linux, Mac OS X, Android, your WebGL enabled browser and iOS.
...
[Ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,716 | 🐛 662 | 🌐 TypeScript | 📅 2026-06-18 is a library which was made for and is used by ethers.io. It is designed to make it easier to write client-side JavaScript based wallets, keeping the private key on the owner’s machine at all times.
...
[UniversalSoundboard](https://github.com/dav-apps/UniversalSoundboard) ⭐ 18 | 🐛 8 | 🌐 C# | 📅 2026-09-11 is a customizable soundboard for your Windows 10 device. Add your sounds or music and sort them in categories. You can also add images to your favourite sounds.
...
[Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,421 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 is a graphical processor simulator and assembly editor for the RISC-V instruction set architecture(ISA).

[FireSim](https://github.com/firesim/firesim) ⭐ 1,041 | 🐛 239 | 🌐 Scala | 📅 2026-09-10 is an easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
[DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,609 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04 is an open souce RISC-V cpu core implemented in Verilog from scratch.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,733 | 🐛 535 | 🌐 Python | 📅 2026-09-14 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 44,137 | 🐛 200 | 🌐 Lua | 📅 2026-09-07 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,117 | 🐛 154 | 🌐 Go | 📅 2026-09-14 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,739 | 🐛 101 | 🌐 Rust | 📅 2026-09-14 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.

[Gloo Edge](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,873 | 🌐 Go | 📅 2026-09-14 is a feature-rich, Kubernetes-native ingress controller, and next-generation API gateway built on [Envoy](https://envoy.com/features/saas/).
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,529 | 🐛 6,994 | 🌐 Go | 📅 2026-09-14 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.

[Prisma](https://www.prisma.io) is open source ORM for Node.js, TypeScript, PostgreSQL, MySQL and SQLite.

[Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,818 | 🐛 687 | 🌐 Python | 📅 2023-03-23 is a tool for Serverless Python.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,522 | 🐛 257 | 🌐 Go | 📅 2026-09-14 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,741 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-12 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,824 | 🐛 1,186 | 🌐 Rust | 📅 2026-09-14 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,061 | 🐛 109 | 🌐 Python | 📅 2026-09-14 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.

[PyQuil](https://github.com/rigetti/pyquil) ⭐ 1,497 | 🐛 246 | 🌐 Python | 📅 2026-09-14 is a Python library for quantum programming using [Quil](https://arxiv.org/abs/1608.03355), the quantum instruction language developed at [Rigetti Computing](https://www.rigetti.com/).

[OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,735 | 🐛 31 | 🌐 Python | 📅 2026-09-14 is an open source library for compiling and analyzing quantum algorithms to simulate fermionic systems, including quantum chemistry.

[QuTiP](https://github.com/qutip/qutip) ⭐ 2,072 | 🐛 113 | 🌐 Python | 📅 2026-09-03 is open-source software for simulating the dynamics of closed and open quantum systems. The QuTiP library uses the excellent Numpy, Scipy, and Cython packages as the numerical backend, and graphical output is provided by Matplotlib.
