...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,777 | 🐛 867 | 🌐 C | 📅 2026-08-13 is the friendly OS for IoT
...
[OpenRemote](https://github.com/openremote/openremote) ⭐ 1,839 | 🐛 413 | 🌐 Java | 📅 2026-08-13 is an open source middleware project, which integrates many different protocols and solutions available for smart building, and smart city automation, and offers visualization tools.
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 89,899 | 🐛 3,818 | 🌐 Python | 📅 2026-08-13 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[Contribute to FOSS](https://github.com/KillYourFM/contribute-foss) ⭐ 244 | 🐛 10 | 📅 2024-08-02 by Jason Evangelho, is an entensive Wiki page on how to contribute to the Linux and FOSS community.

[The Open Source Computer Science Degree by Forrest Knight](https://github.com/ForrestKnight/open-source-cs) ⭐ 23,698 | 🐛 41 | 📅 2025-06-11

[My Windows Subsystem for Linux(WSl) Guide](https://github.com/mikeroyal/WSL-Guide) ⭐ 428 | 🐛 0 | 🌐 Rust | 📅 2024-01-04
...
[Bspwm](https://github.com/baskerville/bspwm) ⭐ 8,302 | 🐛 348 | 🌐 C | 📅 2026-06-19, a tiling window manager based on binary space partitioning with a focus on resource efficiency.
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,549 | 🐛 1,123 | 🌐 Go | 📅 2026-08-13 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Airbnb CSS / Sass Style Guide](https://github.com/airbnb/css) ⭐ 6,977 | 🐛 23 | 📅 2024-06-04
...
[mysqljs](https://github.com/mysqljs/mysql) ⭐ 18,623 | 🐛 175 | 🌐 JavaScript | 📅 2024-06-25 is a pure node.js JavaScript Client implementing the MySQL protocol.

[axios](https://github.com/axios/axios) ⭐ 109,230 | 🐛 68 | 🌐 JavaScript | 📅 2026-08-12 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 141,763 | 🐛 4,313 | 🌐 JavaScript | 📅 2026-08-13 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,627 | 🐛 614 | 🌐 TypeScript | 📅 2026-08-13 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).

[Enzyme](https://github.com/enzymejs/enzyme) ⭐ 19,827 | 🐛 282 | 🌐 JavaScript | 📅 2025-10-22 is a JavaScript Testing utility for React that makes it easier to test your React Components' output. The user can also manipulate, traverse, and in some ways simulate runtime given the output.

[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,336 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-13 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.

[Redux](https://github.com/reduxjs/redux) ⭐ 61,515 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-02 is a predictable state container for JavaScript apps.
...
[Expo](https://github.com/expo/expo) ⭐ 51,579 | 🐛 764 | 🌐 TypeScript | 📅 2026-08-13 is an open-source platform for making universal native apps with React.
...
[Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript) ⭐ 148,148 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,368 | 🐛 187 | 🌐 Java | 📅 2026-08-13.
...
[Nebular](https://github.com/akveo/nebular) ⭐ 8,122 | 🐛 928 | 🌐 TypeScript | 📅 2026-01-15 is a customizable Angular 10 UI Library with a focus on beautiful design and ability to adapt it to your brand easily. It comes with 4 visual themes, a powerful theming engine with runtime theme switching, and support of custom css properties mode.
...
[UI-Grid](https://github.com/angular-ui/ui-grid) ⭐ 5,373 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-13 is an AngularJS data grid.
...
[Element](https://github.com/ElemeFE/element) ⭐ 54,067 | 🐛 2,966 | 🌐 Vue | 📅 2024-08-20 is a Vue.js 2.0 UI Toolkit for Web.
...
[The Node.js best practices list ](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,518 | 🐛 136 | 🌐 Dockerfile | 📅 2026-06-15
...
[nvm ](https://github.com/nvm-sh/nvm) ⭐ 94,571 | 🐛 396 | 🌐 Shell | 📅 2026-07-24 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,904 | 🐛 241 | 🌐 JavaScript | 📅 2026-08-13 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.

[AVA](https://github.com/avajs/ava) ⭐ 20,835 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 is a test runner for Node.js with a concise API, detailed error output, embrace of new language features and process isolation that lets you develop with confidence.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,369 | 🐛 689 | 🌐 TypeScript | 📅 2026-08-13 is a repository for high quality TypeScript type definitions.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,596 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-13.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,631 | 🐛 1,511 | 🌐 TypeScript | 📅 2026-08-13 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,382 | 🐛 1,659 | 🌐 Rust | 📅 2026-08-13 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 32,931 | 🐛 416 | 🌐 Rust | 📅 2026-08-11 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,795 | 🐛 1,811 | 🌐 Rust | 📅 2026-08-13 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Servo](https://github.com/servo/servo) ⭐ 37,689 | 🐛 3,140 | 🌐 Rust | 📅 2026-08-13 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,280 | 🐛 406 | 🌐 Rust | 📅 2026-08-13 is a Python Interpreter written in Rust.

[Miri](https://github.com/rust-lang/miri) ⭐ 6,494 | 🐛 175 | 🌐 Rust | 📅 2026-08-13 is an interpreter for Rust's mid-level intermediate representation. It can run binaries and test suites of cargo projects and detect certain classes of undefined behavior. Miri will alsowill also tell you about memory leaks: when there is memory still allocated at the end of the execution, and that memory is not reachable from a global static, Miri will raise an error.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 63,863 | 🐛 34 | 🌐 Rust | 📅 2026-08-11 is a small set of exercises to get you used to reading and writing Rust code.
...
[kotlinx-lincheck](https://github.com/Kotlin/kotlinx-lincheck) ⭐ 691 | 🐛 100 | 🌐 Kotlin | 📅 2026-08-06 is a framework for testing concurrent data structures for correctness.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,866 | 🐛 72 | 🌐 Markdown | 📅 2026-08-12 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,251 | 🐛 9,179 | 🌐 Swift | 📅 2026-08-13
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,391 | 🐛 170 | 🌐 Swift | 📅 2026-08-10 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Act](https://github.com/nektos/act) ⭐ 71,499 | 🐛 361 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.

[Fiber](https://gofiber.io/) is an [Express](https://github.com/expressjs/express) ⭐ 69,353 | 🐛 228 | 🌐 JavaScript | 📅 2026-08-01 inspired web framework built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,428 | 🐛 83 | 🌐 Go | 📅 2026-08-11, the fastest HTTP engine for Go. Designed to ease things up for fast development with zero memory allocation and performance in mind.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,356 | 🐛 1,165 | 🌐 CMake | 📅 2026-08-13 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Play Framework](https://github.com/playframework/playframework) ⭐ 12,618 | 🐛 489 | 🌐 Scala | 📅 2026-08-13 is a web framework combines productivity and performance making it easy to build scalable web applications with Java and Scala.
...
[Gradle Kotlin DSL converter](https://github.com/bernaferrari/GradleKotlinConverter) ⭐ 948 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-05 is a tool that converts from Groovy to Kotlin DSL for Gradle in Android Studio.

[Rest-assured](https://github.com/rest-assured/rest-assured) ⭐ 7,141 | 🐛 592 | 🌐 Java | 📅 2026-07-22 is a Java DSL for easy testing of REST services.

[Spock](https://github.com/spockframework/spock) ⭐ 3,633 | 🐛 201 | 🌐 Java | 📅 2026-08-07 is a BDD-style developer testing and specification framework for Java and Groovy applications.
...
[Groovy-Eclipse](https://github.com/groovy/groovy-eclipse) ⭐ 681 | 🐛 62 | 🌐 Java | 📅 2026-08-11 is a project that provides Eclipse and Maven tooling support for the Apache Groovy programming language.
...
[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,883 | 🐛 27 | 🌐 Clojure | 📅 2026-01-23 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,390 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 interface to [React](https://facebook.github.io/react/).

[Riemann](https://riemann.io/) is a network event stream processing system for monitoring distributed systems, in Clojure.

[Datascript](https://github.com/tonsky/datascript) ⭐ 5,781 | 🐛 79 | 🌐 Clojure | 📅 2026-08-13 is an immutable in-memory database and Datalog query engine in Clojure, ClojureScript, and JavaScript.

[Compojure](https://github.com/weavejester/compojure) ⭐ 4,111 | 🐛 7 | 🌐 Clojure | 📅 2025-09-15 is a small routing library for [Ring](https://github.com/ring-clojure/ring) ⭐ 3,880 | 🐛 42 | 🌐 Clojure | 📅 2026-06-23 that allows web applications to be composed of small, independent parts.

[Ring](https://github.com/ring-clojure/ring) ⭐ 3,880 | 🐛 42 | 🌐 Clojure | 📅 2026-06-23 is a Clojure web applications library inspired by Python's WSGI and Ruby's Rack. By abstracting the details of HTTP into a simple, unified API, Ring allows web applications to be constructed of modular components that can be shared among a variety of applications, web servers, and web frameworks.
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,097 | 🐛 229 | 🌐 C++ | 📅 2026-08-13 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,596 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-13 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,596 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-13 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,990 | 🐛 199 | 🌐 WebAssembly | 📅 2026-07-22 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,596 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-13.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 8,945 | 🐛 360 | 🌐 C | 📅 2026-08-13 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,062 | 🐛 598 | 🌐 C | 📅 2026-08-13 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,713 | 🐛 113 | 🌐 Go | 📅 2026-08-12 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,596 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-13.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,286 | 🐛 845 | 🌐 JavaScript | 📅 2026-08-13.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,767 | 🐛 134 | 🌐 TypeScript | 📅 2026-08-11, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,632 | 🐛 131 | 🌐 Rust | 📅 2026-08-13 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 325 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 22 | 🌐 TypeSpec | 📅 2026-08-12 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,152 | 🐛 121 | 🌐 Markdown | 📅 2026-08-13 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
...
[.NET for Apache Spark](https://dot.net/spark) provides high performance APIs for using Apache Spark from C# and F#. With these .NET APIs, you can access the most popular Dataframe and SparkSQL aspects of Apache Spark, for working with structured data, and Spark Structured Streaming, for working with streaming data. .NET for Apache Spark runs on Windows, Linux, and macOS using .NET Core, or Windows using .NET Framework. It also runs on all major cloud providers including [Azure HDInsight Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#azure-hdinsight-spark) ⭐ 2,098 | 🐛 200 | 🌐 C# | 📅 2026-07-31, [Amazon EMR Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#amazon-emr-spark) ⭐ 2,098 | 🐛 200 | 🌐 C# | 📅 2026-07-31, [AWS](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,098 | 🐛 200 | 🌐 C# | 📅 2026-07-31 & [Azure](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,098 | 🐛 200 | 🌐 C# | 📅 2026-07-31 Databricks.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,211 | 🐛 7,674 | 🌐 C# | 📅 2026-08-13 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[Polly](https://github.com/App-vNext/Polly) ⭐ 14,227 | 🐛 5 | 🌐 C# | 📅 2026-08-12 is a .NET resilience and transient-fault-handling library that allows developers to express policies such as Retry, Circuit Breaker, Timeout, Bulkhead Isolation, and Fallback in a fluent and thread-safe manner.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,854 | 🐛 189 | 🌐 C# | 📅 2026-08-13 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,299 | 🐛 3,809 | 🌐 C# | 📅 2026-08-13 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,247 | 🐛 8,473 | 🌐 Dart | 📅 2026-08-13 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,381 | 🐛 13,132 | 🌐 Dart | 📅 2026-08-13
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,932 | 🐛 65 | 🌐 Go | 📅 2026-08-12 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,381 | 🐛 13,132 | 🌐 Dart | 📅 2026-08-13 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,689 | 🐛 26 | 🌐 C | 📅 2026-08-02 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,652 | 🐛 432 | 🌐 C++ | 📅 2026-08-13 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-13 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.

[React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-13 is Redux bindings for Firebase that includes React Hooks and Higher Order Components.

[FirebaseUI](https://github.com/firebase/FirebaseUI-Android) ⭐ 4,803 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-13 is an open-source library for Android that allows you to quickly connect common UI elements to Firebase APIs.

[Pyrebase](https://github.com/thisbejim/Pyrebase) ⭐ 2,074 | 🐛 237 | 🌐 Python | 📅 2024-05-14 is a  simple python wrapper for the Firebase API.
...
[ReactFire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,572 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-12 is a project that provides Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
[Mini-QML](https://github.com/patrickelectric/mini-qml) ⭐ 48 | 🐛 4 | 🌐 QML | 📅 2020-08-08 is a minimal Qt deployment for Linux, Windows, macOS and WebAssembly.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,679 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-12 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,554 | 🐛 169 | 🌐 TypeScript | 📅 2026-08-07 v4 and React Bootstrap.
...
[Elixir Style Guide](https://github.com/christopheradams/elixir_style_guide) ⭐ 4,429 | 🐛 8 | 🌐 Elixir | 📅 2024-05-10
...
[CubDB](https://github.com/lucaong/cubdb) ⭐ 653 | 🐛 15 | 🌐 Elixir | 📅 2024-10-02 is an embedded key-value database written in the Elixir language. It runs locally, it is schema-less, and backed by a single file.
...
[Credo](https://github.com/rrrene/credo) ⭐ 5,205 | 🐛 37 | 🌐 Elixir | 📅 2026-07-26 is a static code analysis tool for the Elixir language with a focus on code consistency and teaching.

[Absinthe](https://github.com/absinthe-graphql/absinthe) ⭐ 4,400 | 🐛 71 | 🌐 Elixir | 📅 2026-07-14 is a GraphQL toolkit for Elixir.

[Guardian](https://github.com/ueberauth/guardian) ⭐ 3,513 | 🐛 1 | 🌐 Elixir | 📅 2026-08-01 is a token based authentication library for use with Elixir applications.

[Distillery](https://github.com/bitwalker/distillery) ⭐ 2,955 | 🐛 56 | 🌐 Elixir | 📅 2024-08-04 is a tool that simplify deployments in Elixir with OTP releases.
...
[Floki](https://github.com/philss/floki) ⭐ 2,146 | 🐛 23 | 🌐 Elixir | 📅 2026-06-16 is a simple HTML parser that enables search for nodes using CSS selectors.

[Timex](https://github.com/bitwalker/timex) ⭐ 1,806 | 🐛 68 | 🌐 Elixir | 📅 2025-06-14 is a complete date/time library for Elixir projects.
...
[Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,523 | 🐛 63 | 🌐 Erlang | 📅 2026-07-28 is a small, fast and modern HTTP server for Erlang/OTP.
...
[Hackney](https://github.com/benoitc/hackney) ⭐ 1,416 | 🐛 11 | 🌐 Erlang | 📅 2026-08-12 is a simple HTTP client in Erlang.
...
[Apache APISIX](https://github.com/apache/apisix) ⭐ 16,988 | 🐛 254 | 🌐 Lua | 📅 2026-08-13 is a dynamic, real-time, high-performance API gateway, based on the Nginx library and etcd.
...
[vala-vscode](https://github.com/prince781/vala-vscode) ⭐ 47 | 🐛 10 | 🌐 TypeScript | 📅 2024-07-18 is an extension that provides Vala and Genie integration for Visual Studio such as Syntax highlighting and code intelligence.

[Sequeler](https://github.com/Alecaddd/sequeler) ⭐ 841 | 🐛 69 | 🌐 Vala | 📅 2026-07-03 is a native Linux SQL client built in Vala and Gtk. It allows you to connect to your local and remote databases, write SQL in a handy text editor with language recognition, and visualize SELECT results in a Gtk.Grid Widget.

[Code](https://github.com/elementary/code) ⭐ 518 | 🐛 167 | 🌐 Vala | 📅 2026-08-13 is a fast and lightweight code editor designed for elementary OS.

[Granite](https://github.com/elementary/granite) ⭐ 319 | 🐛 126 | 🌐 Vala | 📅 2026-07-23 is a companion library for GTK+ and GLib. Also, it provides complex widgets and convenience functions designed for use in apps built for elementary OS.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,351 | 🐛 200 | 🌐 Haskell | 📅 2026-08-13 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 595 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-11 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,945 | 🐛 551 | 🌐 Haskell | 📅 2026-08-10.
...
[CodeWorld](https://github.com/google/codeworld) ⭐ 1,269 | 🐛 315 | 🌐 Haskell | 📅 2026-01-25 is an educational environment using Haskell. It provides a simple mathematical model for geometric figures, animations, and interactive and multi-player games.
...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,526 | 🐛 136 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,594 | 🐛 1,738 | 🌐 C++ | 📅 2026-08-13 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more.

[PowerShell Core](https://github.com/PowerShell/PowerShell) ⭐ 54,827 | 🐛 1,593 | 🌐 C# | 📅 2026-08-13 is a cross-platform (Windows, Linux, and macOS) automation and configuration tool/framework that works well with your existing tools and is optimized for dealing with structured data (e.g. JSON, CSV, XML, etc.), REST APIs, and object models. It includes a command-line shell, an associated scripting language and a framework for processing cmdlets.
...
[Pengwin](https://github.com/WhitewaterFoundry/Pengwin) ⭐ 1,520 | 🐛 93 | 🌐 C++ | 📅 2026-02-13 is a Linux distro optimized for WSL based on Debian.

[Pengwin Enterprise](https://github.com/WhitewaterFoundry/Pengwin-Enterprise) ⭐ 69 | 🐛 7 | 🌐 C++ | 📅 2025-12-22 is an enterprise Linux solution for Windows Subsystem for Linux (WSL) that is compatible with mainstream enterprise Linux distributions.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,421 | 🐛 47 | 🌐 CSS | 📅 2026-08-02 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[LibGDX](https://github.com/libgdx/libgdx) ⭐ 25,296 | 🐛 334 | 🌐 Java | 📅 2026-08-12 is a cross-platform Java game development framework based on OpenGL (ES) that works on Windows, Linux, Mac OS X, Android, your WebGL enabled browser and iOS.
...
[Ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,708 | 🐛 656 | 🌐 TypeScript | 📅 2026-06-18 is a library which was made for and is used by ethers.io. It is designed to make it easier to write client-side JavaScript based wallets, keeping the private key on the owner’s machine at all times.
...
[audio-visualizer-python](https://github.com/djfun/audio-visualizer-python) ⭐ 268 | 🐛 5 | 🌐 Python | 📅 2026-07-29 is a little GUI tool which creates an audio visualization video from an input audio. You can also give it a background image and set a title text.
...
[Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,378 | 🐛 90 | 🌐 C++ | 📅 2026-07-23 is a graphical processor simulator and assembly editor for the RISC-V instruction set architecture(ISA).

[FireSim](https://github.com/firesim/firesim) ⭐ 1,032 | 🐛 240 | 🌐 Scala | 📅 2026-06-26 is an easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
[RISC-V Rust](https://github.com/takahirox/riscv-rust) ⭐ 693 | 🐛 45 | 🌐 Rust | 📅 2023-04-06 is a RISC-V processor and peripheral devices emulator project written in Rust and compiled to WebAssembly.
...
[DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,598 | 🐛 5 | 🌐 Verilog | 📅 2026-05-12 is an open souce RISC-V cpu core implemented in Verilog from scratch.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,727 | 🐛 531 | 🌐 Python | 📅 2026-08-13 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 43,974 | 🐛 188 | 🌐 Lua | 📅 2026-08-04 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,065 | 🐛 155 | 🌐 Go | 📅 2026-08-13 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,040 | 🐛 99 | 🌐 Rust | 📅 2026-08-13 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.

[Gloo Edge](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,862 | 🌐 Go | 📅 2026-08-13 is a feature-rich, Kubernetes-native ingress controller, and next-generation API gateway built on [Envoy](https://envoy.com/features/saas/).
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,425 | 🐛 6,785 | 🌐 Go | 📅 2026-08-13 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.

[Prisma](https://www.prisma.io) is open source ORM for Node.js, TypeScript, PostgreSQL, MySQL and SQLite.

[Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,823 | 🐛 686 | 🌐 Python | 📅 2023-03-23 is a tool for Serverless Python.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,429 | 🐛 241 | 🌐 Go | 📅 2026-08-13 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,738 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-12 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,618 | 🐛 1,093 | 🌐 Rust | 📅 2026-08-13 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,044 | 🐛 119 | 🌐 Python | 📅 2026-08-13 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.

[PyQuil](https://github.com/rigetti/pyquil) ⭐ 1,496 | 🐛 244 | 🌐 Python | 📅 2026-07-29 is a Python library for quantum programming using [Quil](https://arxiv.org/abs/1608.03355), the quantum instruction language developed at [Rigetti Computing](https://www.rigetti.com/).

[OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,727 | 🐛 33 | 🌐 Python | 📅 2026-08-10 is an open source library for compiling and analyzing quantum algorithms to simulate fermionic systems, including quantum chemistry.

[QuTiP](https://github.com/qutip/qutip) ⭐ 2,057 | 🐛 108 | 🌐 Python | 📅 2026-08-10 is open-source software for simulating the dynamics of closed and open quantum systems. The QuTiP library uses the excellent Numpy, Scipy, and Cython packages as the numerical backend, and graphical output is provided by Matplotlib.

[ProjectQ](https://github.com/ProjectQ-Framework/ProjectQ) ⭐ 976 | 🐛 41 | 🌐 Python | 📅 2026-08-10 is an open source software framework for quantum computing.
