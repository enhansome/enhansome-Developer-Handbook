...
[K3s](https://github.com/rancher/k3s) ⭐ 33,805 | 🐛 71 | 🌐 Go | 📅 2026-08-22 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,777 | 🐛 872 | 🌐 C | 📅 2026-08-24 is the friendly OS for IoT
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 90,090 | 🐛 3,889 | 🌐 Python | 📅 2026-08-24 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[The Python Open Source Computer Science Degree by Forrest Knight](https://github.com/ForrestKnight/open-source-cs-python) ⭐ 3,960 | 🐛 19 | 📅 2025-06-11
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,113 | 🐛 142 | 🌐 Python | 📅 2026-08-18 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,596 | 🐛 338 | 🌐 Python | 📅 2026-08-24 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[axios](https://github.com/axios/axios) ⭐ 109,201 | 🐛 78 | 🌐 JavaScript | 📅 2026-08-24 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 141,915 | 🐛 3,933 | 🌐 JavaScript | 📅 2026-08-24 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,364 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-24 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.
...
[Expo](https://github.com/expo/expo) ⭐ 51,797 | 🐛 732 | 🌐 TypeScript | 📅 2026-08-24 is an open-source platform for making universal native apps with React.
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,386 | 🐛 185 | 🌐 Java | 📅 2026-08-24.
...
[UI-Grid](https://github.com/angular-ui/ui-grid) ⭐ 5,375 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-14 is an AngularJS data grid.
...
[nvm ](https://github.com/nvm-sh/nvm) ⭐ 94,713 | 🐛 393 | 🌐 Shell | 📅 2026-08-18 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,609 | 🐛 558 | 🌐 WebAssembly | 📅 2026-08-24.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,650 | 🐛 1,503 | 🌐 TypeScript | 📅 2026-08-24 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,422 | 🐛 1,660 | 🌐 Rust | 📅 2026-08-24 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 32,994 | 🐛 433 | 🌐 Rust | 📅 2026-08-20 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,288 | 🐛 256 | 🌐 Rust | 📅 2026-08-24 is a fast and correct HTTP library for Rust.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 63,937 | 🐛 34 | 🌐 Rust | 📅 2026-08-22 is a small set of exercises to get you used to reading and writing Rust code.
...
[kotlinx-lincheck](https://github.com/Kotlin/kotlinx-lincheck) ⭐ 693 | 🐛 99 | 🌐 Kotlin | 📅 2026-08-15 is a framework for testing concurrent data structures for correctness.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,866 | 🐛 79 | 🌐 Markdown | 📅 2026-08-24 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,391 | 🐛 173 | 🌐 Swift | 📅 2026-08-21 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,572 | 🐛 2,533 | 🌐 Go | 📅 2026-08-24 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 71,619 | 🐛 363 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.

[Fiber](https://gofiber.io/) is an [Express](https://github.com/expressjs/express) ⭐ 69,396 | 🐛 224 | 🌐 JavaScript | 📅 2026-08-22 inspired web framework built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,444 | 🐛 91 | 🌐 Go | 📅 2026-08-17, the fastest HTTP engine for Go. Designed to ease things up for fast development with zero memory allocation and performance in mind.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,391 | 🐛 1,187 | 🌐 CMake | 📅 2026-08-24 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,295 | 🐛 1,847 | 🌐 Scala | 📅 2026-08-24 is a research compiler that will become Scala 3.
...
[Spock](https://github.com/spockframework/spock) ⭐ 3,631 | 🐛 203 | 🌐 Java | 📅 2026-08-22 is a BDD-style developer testing and specification framework for Java and Groovy applications.
...
[Groovy-Eclipse](https://github.com/groovy/groovy-eclipse) ⭐ 681 | 🐛 63 | 🌐 Java | 📅 2026-08-19 is a project that provides Eclipse and Maven tooling support for the Apache Groovy programming language.
...
[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,887 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,388 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 interface to [React](https://facebook.github.io/react/).

[Riemann](https://riemann.io/) is a network event stream processing system for monitoring distributed systems, in Clojure.

[Datascript](https://github.com/tonsky/datascript) ⭐ 5,783 | 🐛 75 | 🌐 Clojure | 📅 2026-08-15 is an immutable in-memory database and Datalog query engine in Clojure, ClojureScript, and JavaScript.

[Compojure](https://github.com/weavejester/compojure) ⭐ 4,112 | 🐛 7 | 🌐 Clojure | 📅 2025-09-15 is a small routing library for [Ring](https://github.com/ring-clojure/ring) ⭐ 3,883 | 🐛 41 | 🌐 Clojure | 📅 2026-06-23 that allows web applications to be composed of small, independent parts.

[Ring](https://github.com/ring-clojure/ring) ⭐ 3,883 | 🐛 41 | 🌐 Clojure | 📅 2026-06-23 is a Clojure web applications library inspired by Python's WSGI and Ruby's Rack. By abstracting the details of HTTP into a simple, unified API, Ring allows web applications to be constructed of modular components that can be shared among a variety of applications, web servers, and web frameworks.
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,104 | 🐛 226 | 🌐 C++ | 📅 2026-08-21 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,609 | 🐛 558 | 🌐 WebAssembly | 📅 2026-08-24 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,609 | 🐛 558 | 🌐 WebAssembly | 📅 2026-08-24 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,993 | 🐛 201 | 🌐 WebAssembly | 📅 2026-07-22 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,609 | 🐛 558 | 🌐 WebAssembly | 📅 2026-08-24.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 8,972 | 🐛 365 | 🌐 C | 📅 2026-08-24 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,071 | 🐛 605 | 🌐 C | 📅 2026-08-22 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,734 | 🐛 117 | 🌐 Go | 📅 2026-08-22 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,609 | 🐛 558 | 🌐 WebAssembly | 📅 2026-08-24.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,299 | 🐛 846 | 🌐 JavaScript | 📅 2026-08-24.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,772 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-23, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,743 | 🐛 106 | 🌐 Rust | 📅 2026-08-24 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 326 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,798 | 🐛 22 | 🌐 TypeSpec | 📅 2026-08-12 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,174 | 🐛 81 | 🌐 Markdown | 📅 2026-08-24 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,931 | 🐛 181 | 🌐 C# | 📅 2026-08-24 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,310 | 🐛 3,752 | 🌐 C# | 📅 2026-08-24 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,262 | 🐛 8,453 | 🌐 Dart | 📅 2026-08-24 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,635 | 🐛 13,142 | 🌐 Dart | 📅 2026-08-24
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-08-23 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,635 | 🐛 13,142 | 🌐 Dart | 📅 2026-08-24 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,690 | 🐛 22 | 🌐 C | 📅 2026-08-23 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,659 | 🐛 452 | 🌐 C++ | 📅 2026-08-24 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-24 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.
...
[FirebaseUI](https://github.com/firebase/FirebaseUI-Android) ⭐ 4,808 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-24 is an open-source library for Android that allows you to quickly connect common UI elements to Firebase APIs.
...
[ReactFire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-21 is a project that provides Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 15,985 | 🐛 686 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,678 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-21 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,572 | 🐛 172 | 🌐 TypeScript | 📅 2026-08-24 v4 and React Bootstrap.
...
[Credo](https://github.com/rrrene/credo) ⭐ 5,213 | 🐛 38 | 🌐 Elixir | 📅 2026-07-26 is a static code analysis tool for the Elixir language with a focus on code consistency and teaching.
...
[Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,525 | 🐛 64 | 🌐 Erlang | 📅 2026-07-28 is a small, fast and modern HTTP server for Erlang/OTP.
...
[Apache APISIX](https://github.com/apache/apisix) ⭐ 17,025 | 🐛 254 | 🌐 Lua | 📅 2026-08-24 is a dynamic, real-time, high-performance API gateway, based on the Nginx library and etcd.
...
[NLua](https://github.com/NLua/NLua) ⭐ 2,244 | 🐛 111 | 🌐 C# | 📅 2026-05-01 is a bridge between Lua world and the .NET (compatible with .NET Core/UWP/Mac/Linux/Android/iOS/tvOS).
...
[Code](https://github.com/elementary/code) ⭐ 520 | 🐛 157 | 🌐 Vala | 📅 2026-08-24 is a fast and lightweight code editor designed for elementary OS.

[Granite](https://github.com/elementary/granite) ⭐ 321 | 🐛 126 | 🌐 Vala | 📅 2026-08-22 is a companion library for GTK+ and GLib. Also, it provides complex widgets and convenience functions designed for use in apps built for elementary OS.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,367 | 🐛 201 | 🌐 Haskell | 📅 2026-08-24 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 595 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-11 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,952 | 🐛 558 | 🌐 Haskell | 📅 2026-08-23.
...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,538 | 🐛 134 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,685 | 🐛 1,743 | 🌐 C++ | 📅 2026-08-21 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more.

[PowerShell Core](https://github.com/PowerShell/PowerShell) ⭐ 55,099 | 🐛 1,605 | 🌐 C# | 📅 2026-08-20 is a cross-platform (Windows, Linux, and macOS) automation and configuration tool/framework that works well with your existing tools and is optimized for dealing with structured data (e.g. JSON, CSV, XML, etc.), REST APIs, and object models. It includes a command-line shell, an associated scripting language and a framework for processing cmdlets.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,455 | 🐛 1,011 | 🌐 C++ | 📅 2026-08-20 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,607 | 🐛 46 | 🌐 Python | 📅 2026-08-15 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[LibGDX](https://github.com/libgdx/libgdx) ⭐ 25,332 | 🐛 340 | 🌐 Java | 📅 2026-08-23 is a cross-platform Java game development framework based on OpenGL (ES) that works on Windows, Linux, Mac OS X, Android, your WebGL enabled browser and iOS.

[cocos2d-x](https://github.com/cocos2d/cocos2d-x) ⭐ 19,160 | 🐛 1,604 | 🌐 C++ | 📅 2025-05-09 is a multi-platform framework for building 2d games, interactive books, demos and other graphical applications. It is based on cocos2d-iphone, but instead of using Objective-C, it uses C++. It works on iOS, Android, macOS, Windows and Linux.

[MonoGame](https://github.com/MonoGame/MonoGame) ⭐ 14,342 | 🐛 756 | 🌐 C# | 📅 2026-08-24 is a framework for creating powerful cross-platform games. The spiritual successor to XNA with thousands of titles shipped across desktop, mobile, and console platforms. MonoGame is a fully managed .NET open source game framework without any black boxes.
...
[Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,388 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 is a graphical processor simulator and assembly editor for the RISC-V instruction set architecture(ISA).

[FireSim](https://github.com/firesim/firesim) ⭐ 1,035 | 🐛 239 | 🌐 Scala | 📅 2026-06-26 is an easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
[DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,599 | 🐛 5 | 🌐 Verilog | 📅 2026-05-12 is an open souce RISC-V cpu core implemented in Verilog from scratch.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,731 | 🐛 536 | 🌐 Python | 📅 2026-08-24 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 44,029 | 🐛 190 | 🌐 Lua | 📅 2026-08-16 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,101 | 🐛 156 | 🌐 Go | 📅 2026-08-13 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,240 | 🐛 114 | 🌐 Rust | 📅 2026-08-24 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.

[Gloo Edge](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,867 | 🌐 Go | 📅 2026-08-21 is a feature-rich, Kubernetes-native ingress controller, and next-generation API gateway built on [Envoy](https://envoy.com/features/saas/).
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,464 | 🐛 6,829 | 🌐 Go | 📅 2026-08-24 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,466 | 🐛 237 | 🌐 Go | 📅 2026-08-24 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,742 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-24 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,688 | 🐛 1,127 | 🌐 Rust | 📅 2026-08-24 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,002 | 🐛 44 | 🌐 Python | 📅 2026-08-24 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,053 | 🐛 114 | 🌐 Python | 📅 2026-08-21 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.
...
[OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,730 | 🐛 31 | 🌐 Python | 📅 2026-08-18 is an open source library for compiling and analyzing quantum algorithms to simulate fermionic systems, including quantum chemistry.

[QuTiP](https://github.com/qutip/qutip) ⭐ 2,058 | 🐛 113 | 🌐 Python | 📅 2026-08-24 is open-source software for simulating the dynamics of closed and open quantum systems. The QuTiP library uses the excellent Numpy, Scipy, and Cython packages as the numerical backend, and graphical output is provided by Matplotlib.
