...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,776 | 🐛 861 | 🌐 C | 📅 2026-08-20 is the friendly OS for IoT
...
[OpenRemote](https://github.com/openremote/openremote) ⭐ 1,874 | 🐛 423 | 🌐 Java | 📅 2026-08-20 is an open source middleware project, which integrates many different protocols and solutions available for smart building, and smart city automation, and offers visualization tools.
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 90,008 | 🐛 3,881 | 🌐 Python | 📅 2026-08-20 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,303 | 🐛 617 | 🌐 Go | 📅 2026-08-17 is an unsupervised, coverage-guided kernel fuzzer.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,248 | 🐛 214 | 🌐 C | 📅 2026-07-30 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,592 | 🐛 331 | 🌐 Python | 📅 2026-08-19 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,083 | 🐛 3 | 🌐 Python | 📅 2026-08-20 is an easy to use, scriptable and scalable performance testing tool.
...
[Airbnb CSS / Sass Style Guide](https://github.com/airbnb/css) ⭐ 6,975 | 🐛 23 | 📅 2024-06-04
...
[axios](https://github.com/axios/axios) ⭐ 109,194 | 🐛 74 | 🌐 JavaScript | 📅 2026-08-20 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 141,881 | 🐛 4,065 | 🌐 JavaScript | 📅 2026-08-20 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,631 | 🐛 621 | 🌐 TypeScript | 📅 2026-08-13 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,355 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-20 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.

[Redux](https://github.com/reduxjs/redux) ⭐ 61,507 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-20 is a predictable state container for JavaScript apps.
...
[Expo](https://github.com/expo/expo) ⭐ 51,715 | 🐛 730 | 🌐 TypeScript | 📅 2026-08-20 is an open-source platform for making universal native apps with React.
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,381 | 🐛 186 | 🌐 Java | 📅 2026-08-20.
...
[nvm ](https://github.com/nvm-sh/nvm) ⭐ 94,662 | 🐛 394 | 🌐 Shell | 📅 2026-08-18 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,902 | 🐛 262 | 🌐 JavaScript | 📅 2026-08-19 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,380 | 🐛 678 | 🌐 TypeScript | 📅 2026-08-20 is a repository for high quality TypeScript type definitions.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,604 | 🐛 563 | 🌐 WebAssembly | 📅 2026-08-20.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,636 | 🐛 1,500 | 🌐 TypeScript | 📅 2026-08-20 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,395 | 🐛 1,658 | 🌐 Rust | 📅 2026-08-19 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 32,965 | 🐛 427 | 🌐 Rust | 📅 2026-08-20 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Servo](https://github.com/servo/servo) ⭐ 37,744 | 🐛 3,140 | 🌐 Rust | 📅 2026-08-20 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,291 | 🐛 405 | 🌐 Rust | 📅 2026-08-20 is a Python Interpreter written in Rust.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,869 | 🐛 75 | 🌐 Markdown | 📅 2026-08-19 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,263 | 🐛 9,211 | 🌐 Swift | 📅 2026-08-20
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,516 | 🐛 904 | 🌐 Go | 📅 2026-08-20 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.

[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,516 | 🐛 2,536 | 🌐 Go | 📅 2026-08-20 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 71,575 | 🐛 363 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,256 | 🐛 246 | 🌐 CSS | 📅 2026-08-06
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,379 | 🐛 1,148 | 🌐 CMake | 📅 2026-08-20 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Guava](https://github.com/google/guava) ⭐ 51,889 | 🐛 748 | 🌐 Java | 📅 2026-08-20 is a set of core Java libraries from Google that includes new collection types (such as multimap and multiset), immutable collections, a graph library, and utilities for concurrency, I/O, hashing, caching, primitives, strings, and more! It is widely used on most Java projects within Google, and widely used by many other companies as well.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,292 | 🐛 1,840 | 🌐 Scala | 📅 2026-08-20 is a research compiler that will become Scala 3.
...
[Groovy-Eclipse](https://github.com/groovy/groovy-eclipse) ⭐ 681 | 🐛 62 | 🌐 Java | 📅 2026-08-19 is a project that provides Eclipse and Maven tooling support for the Apache Groovy programming language.
...
[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,886 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,390 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 interface to [React](https://facebook.github.io/react/).

[Riemann](https://riemann.io/) is a network event stream processing system for monitoring distributed systems, in Clojure.

[Datascript](https://github.com/tonsky/datascript) ⭐ 5,782 | 🐛 75 | 🌐 Clojure | 📅 2026-08-15 is an immutable in-memory database and Datalog query engine in Clojure, ClojureScript, and JavaScript.

[Compojure](https://github.com/weavejester/compojure) ⭐ 4,112 | 🐛 7 | 🌐 Clojure | 📅 2025-09-15 is a small routing library for [Ring](https://github.com/ring-clojure/ring) ⭐ 3,882 | 🐛 42 | 🌐 Clojure | 📅 2026-06-23 that allows web applications to be composed of small, independent parts.

[Ring](https://github.com/ring-clojure/ring) ⭐ 3,882 | 🐛 42 | 🌐 Clojure | 📅 2026-06-23 is a Clojure web applications library inspired by Python's WSGI and Ruby's Rack. By abstracting the details of HTTP into a simple, unified API, Ring allows web applications to be constructed of modular components that can be shared among a variety of applications, web servers, and web frameworks.
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,102 | 🐛 227 | 🌐 C++ | 📅 2026-08-20 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,604 | 🐛 563 | 🌐 WebAssembly | 📅 2026-08-20 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,604 | 🐛 563 | 🌐 WebAssembly | 📅 2026-08-20 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,990 | 🐛 201 | 🌐 WebAssembly | 📅 2026-07-22 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,604 | 🐛 563 | 🌐 WebAssembly | 📅 2026-08-20.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 8,963 | 🐛 366 | 🌐 C | 📅 2026-08-13 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,071 | 🐛 595 | 🌐 C | 📅 2026-08-20 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,723 | 🐛 114 | 🌐 Go | 📅 2026-08-20 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,604 | 🐛 563 | 🌐 WebAssembly | 📅 2026-08-20.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,770 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-19, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,709 | 🐛 122 | 🌐 Rust | 📅 2026-08-20 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 327 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 22 | 🌐 TypeSpec | 📅 2026-08-12 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,163 | 🐛 116 | 🌐 Markdown | 📅 2026-08-20 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
...
[.NET for Apache Spark](https://dot.net/spark) provides high performance APIs for using Apache Spark from C# and F#. With these .NET APIs, you can access the most popular Dataframe and SparkSQL aspects of Apache Spark, for working with structured data, and Spark Structured Streaming, for working with streaming data. .NET for Apache Spark runs on Windows, Linux, and macOS using .NET Core, or Windows using .NET Framework. It also runs on all major cloud providers including [Azure HDInsight Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#azure-hdinsight-spark) ⭐ 2,099 | 🐛 200 | 🌐 C# | 📅 2026-08-19, [Amazon EMR Spark](https://github.com/dotnet/spark/blob/master/deployment/README.md#amazon-emr-spark) ⭐ 2,099 | 🐛 200 | 🌐 C# | 📅 2026-08-19, [AWS](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,099 | 🐛 200 | 🌐 C# | 📅 2026-08-19 & [Azure](https://github.com/dotnet/spark/blob/master/deployment/README.md#databricks) ⭐ 2,099 | 🐛 200 | 🌐 C# | 📅 2026-08-19 Databricks.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,219 | 🐛 7,582 | 🌐 C# | 📅 2026-08-20 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,900 | 🐛 189 | 🌐 C# | 📅 2026-08-20 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,309 | 🐛 3,712 | 🌐 C# | 📅 2026-08-20 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,256 | 🐛 8,455 | 🌐 Dart | 📅 2026-08-20 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,526 | 🐛 13,156 | 🌐 Dart | 📅 2026-08-20
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,930 | 🐛 65 | 🌐 Go | 📅 2026-08-19 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,526 | 🐛 13,156 | 🌐 Dart | 📅 2026-08-20 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,690 | 🐛 26 | 🌐 C | 📅 2026-08-02 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,658 | 🐛 446 | 🌐 C++ | 📅 2026-08-20 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,300 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-20 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.
...
[FirebaseUI](https://github.com/firebase/FirebaseUI-Android) ⭐ 4,805 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-19 is an open-source library for Android that allows you to quickly connect common UI elements to Firebase APIs.
...
[ReactFire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-19 is a project that provides Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
[Infer](https://github.com/facebook/infer) ⭐ 15,684 | 🐛 297 | 🌐 OCaml | 📅 2026-08-19 is a static analysis tool for Java, C++, Objective-C, and C.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,679 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-18 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,561 | 🐛 164 | 🌐 TypeScript | 📅 2026-08-20 v4 and React Bootstrap.
...
[Elixir Style Guide](https://github.com/christopheradams/elixir_style_guide) ⭐ 4,428 | 🐛 8 | 🌐 Elixir | 📅 2024-05-10
...
[Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,526 | 🐛 64 | 🌐 Erlang | 📅 2026-07-28 is a small, fast and modern HTTP server for Erlang/OTP.
...
[Code](https://github.com/elementary/code) ⭐ 518 | 🐛 162 | 🌐 Vala | 📅 2026-08-19 is a fast and lightweight code editor designed for elementary OS.

[Granite](https://github.com/elementary/granite) ⭐ 321 | 🐛 128 | 🌐 Vala | 📅 2026-08-20 is a companion library for GTK+ and GLib. Also, it provides complex widgets and convenience functions designed for use in apps built for elementary OS.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,364 | 🐛 203 | 🌐 Haskell | 📅 2026-08-17 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 595 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-11 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,950 | 🐛 555 | 🌐 Haskell | 📅 2026-08-16.
...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,536 | 🐛 134 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,639 | 🐛 1,737 | 🌐 C++ | 📅 2026-08-20 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more.

[PowerShell Core](https://github.com/PowerShell/PowerShell) ⭐ 55,018 | 🐛 1,600 | 🌐 C# | 📅 2026-08-19 is a cross-platform (Windows, Linux, and macOS) automation and configuration tool/framework that works well with your existing tools and is optimized for dealing with structured data (e.g. JSON, CSV, XML, etc.), REST APIs, and object models. It includes a command-line shell, an associated scripting language and a framework for processing cmdlets.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,451 | 🐛 1,011 | 🌐 C++ | 📅 2026-08-06 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,510 | 🐛 45 | 🌐 Python | 📅 2026-08-15 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[LibGDX](https://github.com/libgdx/libgdx) ⭐ 25,312 | 🐛 335 | 🌐 Java | 📅 2026-08-12 is a cross-platform Java game development framework based on OpenGL (ES) that works on Windows, Linux, Mac OS X, Android, your WebGL enabled browser and iOS.
...
[Ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,712 | 🐛 662 | 🌐 TypeScript | 📅 2026-06-18 is a library which was made for and is used by ethers.io. It is designed to make it easier to write client-side JavaScript based wallets, keeping the private key on the owner’s machine at all times.
...
[Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,383 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 is a graphical processor simulator and assembly editor for the RISC-V instruction set architecture(ISA).

[FireSim](https://github.com/firesim/firesim) ⭐ 1,032 | 🐛 239 | 🌐 Scala | 📅 2026-06-26 is an easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,729 | 🐛 538 | 🌐 Python | 📅 2026-08-20 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 44,009 | 🐛 189 | 🌐 Lua | 📅 2026-08-16 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,101 | 🐛 156 | 🌐 Go | 📅 2026-08-13 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,169 | 🐛 110 | 🌐 Rust | 📅 2026-08-20 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.

[Gloo Edge](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,868 | 🌐 Go | 📅 2026-08-20 is a feature-rich, Kubernetes-native ingress controller, and next-generation API gateway built on [Envoy](https://envoy.com/features/saas/).
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,456 | 🐛 6,826 | 🌐 Go | 📅 2026-08-20 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,451 | 🐛 233 | 🌐 Go | 📅 2026-08-20 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,741 | 🐛 114 | 🌐 TypeScript | 📅 2026-08-16 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,671 | 🐛 1,117 | 🌐 Rust | 📅 2026-08-20 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,004 | 🐛 41 | 🌐 Python | 📅 2026-08-20 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,052 | 🐛 118 | 🌐 Python | 📅 2026-08-20 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.
...
[OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,729 | 🐛 31 | 🌐 Python | 📅 2026-08-18 is an open source library for compiling and analyzing quantum algorithms to simulate fermionic systems, including quantum chemistry.

[QuTiP](https://github.com/qutip/qutip) ⭐ 2,056 | 🐛 111 | 🌐 Python | 📅 2026-08-20 is open-source software for simulating the dynamics of closed and open quantum systems. The QuTiP library uses the excellent Numpy, Scipy, and Cython packages as the numerical backend, and graphical output is provided by Matplotlib.
