...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,777 | 🐛 866 | 🌐 C | 📅 2026-08-19 is the friendly OS for IoT
...
[OpenRemote](https://github.com/openremote/openremote) ⭐ 1,872 | 🐛 421 | 🌐 Java | 📅 2026-08-19 is an open source middleware project, which integrates many different protocols and solutions available for smart building, and smart city automation, and offers visualization tools.
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 89,977 | 🐛 3,865 | 🌐 Python | 📅 2026-08-19 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[The Open Source Computer Science Degree by Forrest Knight](https://github.com/ForrestKnight/open-source-cs) ⭐ 23,706 | 🐛 41 | 📅 2025-06-11
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,632 | 🐛 1,126 | 🌐 Go | 📅 2026-08-19 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,246 | 🐛 212 | 🌐 C | 📅 2026-07-30 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Locust](https://github.com/locustio/locust) ⭐ 28,081 | 🐛 2 | 🌐 Python | 📅 2026-08-19 is an easy to use, scriptable and scalable performance testing tool.
...
[axios](https://github.com/axios/axios) ⭐ 109,199 | 🐛 70 | 🌐 JavaScript | 📅 2026-08-19 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 141,868 | 🐛 4,092 | 🌐 JavaScript | 📅 2026-08-19 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,629 | 🐛 621 | 🌐 TypeScript | 📅 2026-08-13 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,353 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-19 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.

[Redux](https://github.com/reduxjs/redux) ⭐ 61,508 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-02 is a predictable state container for JavaScript apps.
...
[Expo](https://github.com/expo/expo) ⭐ 51,702 | 🐛 739 | 🌐 TypeScript | 📅 2026-08-19 is an open-source platform for making universal native apps with React.
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,381 | 🐛 186 | 🌐 Java | 📅 2026-08-19.
...
[Element](https://github.com/ElemeFE/element) ⭐ 54,056 | 🐛 2,965 | 🌐 Vue | 📅 2024-08-20 is a Vue.js 2.0 UI Toolkit for Web.
...
[Node.js Build Working Group](https://github.com/nodejs/build) ⭐ 540 | 🐛 145 | 🌐 Jinja | 📅 2026-08-19 maintains and controls infrastructure used for continuous integration (CI), releases, benchmarks, web hosting (of nodejs.org and other Node.js web properties) and more.
...
[nvm ](https://github.com/nvm-sh/nvm) ⭐ 94,656 | 🐛 394 | 🌐 Shell | 📅 2026-08-18 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,377 | 🐛 679 | 🌐 TypeScript | 📅 2026-08-19 is a repository for high quality TypeScript type definitions.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,601 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-18.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,634 | 🐛 1,506 | 🌐 TypeScript | 📅 2026-08-19 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,393 | 🐛 1,658 | 🌐 Rust | 📅 2026-08-19 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 32,955 | 🐛 425 | 🌐 Rust | 📅 2026-08-17 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,807 | 🐛 1,807 | 🌐 Rust | 📅 2026-08-19 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,278 | 🐛 259 | 🌐 Rust | 📅 2026-08-17 is a fast and correct HTTP library for Rust.
...
[Servo](https://github.com/servo/servo) ⭐ 37,734 | 🐛 3,148 | 🌐 Rust | 📅 2026-08-19 is a prototype web browser engine written in the Rust language.
...
[Simpleinfra](https://github.com/rust-lang/simpleinfra) ⭐ 175 | 🐛 69 | 🌐 HCL | 📅 2026-08-19 is rep that contains the tools and automation written by the Rust infrastructure team to manage our services. Using some of the tools in this repo require privileges only infra team members have.

[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 63,905 | 🐛 33 | 🌐 Rust | 📅 2026-08-11 is a small set of exercises to get you used to reading and writing Rust code.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,258 | 🐛 9,207 | 🌐 Swift | 📅 2026-08-19
...
[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,495 | 🐛 2,542 | 🌐 Go | 📅 2026-08-19 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 71,556 | 🐛 362 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.
...
[zap](https://github.com/uber-go/zap) ⭐ 24,631 | 🐛 189 | 🌐 Go | 📅 2026-08-05 is a blazing fast, structured, leveled logging in Go.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,375 | 🐛 1,140 | 🌐 CMake | 📅 2026-08-19 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,499 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 is a very fast, header-only/compiled, C++ logging library.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,291 | 🐛 1,835 | 🌐 Scala | 📅 2026-08-19 is a research compiler that will become Scala 3.
...
[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,885 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,390 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 interface to [React](https://facebook.github.io/react/).
...
[Compojure](https://github.com/weavejester/compojure) ⭐ 4,111 | 🐛 7 | 🌐 Clojure | 📅 2025-09-15 is a small routing library for [Ring](https://github.com/ring-clojure/ring) ⭐ 3,881 | 🐛 42 | 🌐 Clojure | 📅 2026-06-23 that allows web applications to be composed of small, independent parts.

[Ring](https://github.com/ring-clojure/ring) ⭐ 3,881 | 🐛 42 | 🌐 Clojure | 📅 2026-06-23 is a Clojure web applications library inspired by Python's WSGI and Ruby's Rack. By abstracting the details of HTTP into a simple, unified API, Ring allows web applications to be constructed of modular components that can be shared among a variety of applications, web servers, and web frameworks.
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,103 | 🐛 230 | 🌐 C++ | 📅 2026-08-18 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,601 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-18 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,601 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-18 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,989 | 🐛 199 | 🌐 WebAssembly | 📅 2026-07-22 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,601 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-18.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 8,963 | 🐛 365 | 🌐 C | 📅 2026-08-13 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,071 | 🐛 598 | 🌐 C | 📅 2026-08-18 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,723 | 🐛 114 | 🌐 Go | 📅 2026-08-18 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,601 | 🐛 561 | 🌐 WebAssembly | 📅 2026-08-18.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,771 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-19, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,691 | 🐛 123 | 🌐 Rust | 📅 2026-08-18 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 327 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,211 | 🐛 7,586 | 🌐 C# | 📅 2026-08-19 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,894 | 🐛 186 | 🌐 C# | 📅 2026-08-19 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,306 | 🐛 3,733 | 🌐 C# | 📅 2026-08-19 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,254 | 🐛 8,454 | 🌐 Dart | 📅 2026-08-19 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,497 | 🐛 13,161 | 🌐 Dart | 📅 2026-08-19
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,656 | 🐛 445 | 🌐 C++ | 📅 2026-08-19 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,300 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-19 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,679 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-18 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,557 | 🐛 163 | 🌐 TypeScript | 📅 2026-08-19 v4 and React Bootstrap.
...
[Apache APISIX](https://github.com/apache/apisix) ⭐ 17,007 | 🐛 245 | 🌐 Lua | 📅 2026-08-19 is a dynamic, real-time, high-performance API gateway, based on the Nginx library and etcd.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,363 | 🐛 203 | 🌐 Haskell | 📅 2026-08-17 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 595 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-11 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,948 | 🐛 554 | 🌐 Haskell | 📅 2026-08-16.
...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,533 | 🐛 136 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,499 | 🐛 45 | 🌐 Python | 📅 2026-08-15 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[LibGDX](https://github.com/libgdx/libgdx) ⭐ 25,308 | 🐛 335 | 🌐 Java | 📅 2026-08-12 is a cross-platform Java game development framework based on OpenGL (ES) that works on Windows, Linux, Mac OS X, Android, your WebGL enabled browser and iOS.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,728 | 🐛 536 | 🌐 Python | 📅 2026-08-19 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 44,003 | 🐛 189 | 🌐 Lua | 📅 2026-08-16 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,101 | 🐛 156 | 🌐 Go | 📅 2026-08-13 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,146 | 🐛 105 | 🌐 Rust | 📅 2026-08-19 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.

[Gloo Edge](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,865 | 🌐 Go | 📅 2026-08-19 is a feature-rich, Kubernetes-native ingress controller, and next-generation API gateway built on [Envoy](https://envoy.com/features/saas/).
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,448 | 🐛 6,802 | 🌐 Go | 📅 2026-08-19 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,446 | 🐛 232 | 🌐 Go | 📅 2026-08-19 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,740 | 🐛 114 | 🌐 TypeScript | 📅 2026-08-16 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,663 | 🐛 1,118 | 🌐 Rust | 📅 2026-08-19 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Refit](https://github.com/reactiveui/refit) ⭐ 9,562 | 🐛 1 | 🌐 C# | 📅 2026-08-18 is the automatic type-safe REST library for .NET Core,.NET and Xamarin.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,051 | 🐛 120 | 🌐 Python | 📅 2026-08-19 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.

[PyQuil](https://github.com/rigetti/pyquil) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-08-19 is a Python library for quantum programming using [Quil](https://arxiv.org/abs/1608.03355), the quantum instruction language developed at [Rigetti Computing](https://www.rigetti.com/).
...
[QuTiP](https://github.com/qutip/qutip) ⭐ 2,055 | 🐛 113 | 🌐 Python | 📅 2026-08-18 is open-source software for simulating the dynamics of closed and open quantum systems. The QuTiP library uses the excellent Numpy, Scipy, and Cython packages as the numerical backend, and graphical output is provided by Matplotlib.
