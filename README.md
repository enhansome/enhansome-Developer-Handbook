...
[RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,804 | 🐛 889 | 🌐 C | 📅 2026-09-22 is the friendly OS for IoT
...
[OpenRemote](https://github.com/openremote/openremote) ⭐ 1,909 | 🐛 450 | 🌐 Java | 📅 2026-09-22 is an open source middleware project, which integrates many different protocols and solutions available for smart building, and smart city automation, and offers visualization tools.
...
[Home Assistant](https://github.com/home-assistant/core) ⭐ 91,051 | 🐛 3,595 | 🌐 Python | 📅 2026-09-22 is open source home automation that puts local control and privacy first. Powered by a worldwide community of tinkerers and DIY enthusiasts. Perfect to run on a Raspberry Pi or a local server.
...
[The Open Source Computer Science Degree by Forrest Knight](https://github.com/ForrestKnight/open-source-cs) ⭐ 23,761 | 🐛 41 | 📅 2025-06-11
...
[Bspwm](https://github.com/baskerville/bspwm) ⭐ 8,317 | 🐛 348 | 🌐 C | 📅 2026-06-19, a tiling window manager based on binary space partitioning with a focus on resource efficiency.
...
[Compute Library](https://github.com/ARM-software/ComputeLibrary) ⭐ 3,192 | 🐛 9 | 🌐 C++ | 📅 2026-09-22 is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,653 | 🐛 342 | 🌐 Python | 📅 2026-09-22 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[axios](https://github.com/axios/axios) ⭐ 109,213 | 🐛 96 | 🌐 JavaScript | 📅 2026-09-22 is a promise based HTTP client for the browser and node.js.
...
[Next.js](https://github.com/vercel/next.js) ⭐ 142,404 | 🐛 3,475 | 🌐 JavaScript | 📅 2026-09-22 is a React Framework for production gives you the best developer experience with all the features needed for production such as hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more.
...
[Enzyme](https://github.com/enzymejs/enzyme) ⭐ 19,814 | 🐛 282 | 🌐 JavaScript | 📅 2025-10-22 is a JavaScript Testing utility for React that makes it easier to test your React Components' output. The user can also manipulate, traverse, and in some ways simulate runtime given the output.

[RxDB](https://github.com/pubkey/rxdb) ⭐ 23,390 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-21 is a NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and NodeJs.

[Redux](https://github.com/reduxjs/redux) ⭐ 61,489 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-22 is a predictable state container for JavaScript apps.
...
[Expo](https://github.com/expo/expo) ⭐ 52,385 | 🐛 931 | 🌐 TypeScript | 📅 2026-09-22 is an open-source platform for making universal native apps with React.
...
[Protractor](https://angular.github.io/protractor) is an end-to-end test framework for Angular and AngularJS applications. Protractor is a [Node.js](http://nodejs.org/) program built on top of [WebDriverJS](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,511 | 🐛 189 | 🌐 Java | 📅 2026-09-22.
...
[Nebular](https://github.com/akveo/nebular) ⭐ 8,118 | 🐛 930 | 🌐 TypeScript | 📅 2026-01-15 is a customizable Angular 10 UI Library with a focus on beautiful design and ability to adapt it to your brand easily. It comes with 4 visual themes, a powerful theming engine with runtime theme switching, and support of custom css properties mode.
...
[UI-Grid](https://github.com/angular-ui/ui-grid) ⭐ 5,382 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-18 is an AngularJS data grid.
...
[Element](https://github.com/ElemeFE/element) ⭐ 54,048 | 🐛 2,966 | 🌐 Vue | 📅 2024-08-20 is a Vue.js 2.0 UI Toolkit for Web.
...
[nvm ](https://github.com/nvm-sh/nvm) ⭐ 95,167 | 🐛 390 | 🌐 Shell | 📅 2026-09-21 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,897 | 🐛 233 | 🌐 JavaScript | 📅 2026-09-22 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,439 | 🐛 701 | 🌐 TypeScript | 📅 2026-09-22 is a repository for high quality TypeScript type definitions.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,632 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-22.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,699 | 🐛 1,528 | 🌐 TypeScript | 📅 2026-09-22 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,506 | 🐛 1,674 | 🌐 Rust | 📅 2026-09-21 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[TiKV](https://github.com/tikv/tikv) ⭐ 16,872 | 🐛 1,823 | 🌐 Rust | 📅 2026-09-21 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Servo](https://github.com/servo/servo) ⭐ 38,024 | 🐛 3,230 | 🌐 Rust | 📅 2026-09-22 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,351 | 🐛 397 | 🌐 Rust | 📅 2026-09-22 is a Python Interpreter written in Rust.

[Miri](https://github.com/rust-lang/miri) ⭐ 6,609 | 🐛 192 | 🌐 Rust | 📅 2026-09-22 is an interpreter for Rust's mid-level intermediate representation. It can run binaries and test suites of cargo projects and detect certain classes of undefined behavior. Miri will alsowill also tell you about memory leaks: when there is memory still allocated at the end of the execution, and that memory is not reachable from a global static, Miri will raise an error.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,191 | 🐛 37 | 🌐 Rust | 📅 2026-09-21 is a small set of exercises to get you used to reading and writing Rust code.
...
[Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,673 | 🐛 196 | 🌐 Rust | 📅 2026-09-22 is an open-source Linux-based operating system meant for hosting containers. Bottlerocket focuses on security and maintainability, providing a reliable, consistent, and safe platform for container-based workloads.
...
[kotlinx-lincheck](https://github.com/Kotlin/kotlinx-lincheck) ⭐ 699 | 🐛 101 | 🌐 Kotlin | 📅 2026-08-30 is a framework for testing concurrent data structures for correctness.

[kotlinx-io](https://github.com/Kotlin/kotlinx-io) ⭐ 1,549 | 🐛 110 | 🌐 Kotlin | 📅 2026-08-05 is a multiplatform library for processing binary data, working with memory blocks, interacting with the platform, and performing other low level operations.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,875 | 🐛 85 | 🌐 Markdown | 📅 2026-09-22 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,380 | 🐛 9,345 | 🌐 Swift | 📅 2026-09-22
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,404 | 🐛 171 | 🌐 Swift | 📅 2026-09-22 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Gravitational Teleport](https://github.com/gravitational/teleport) ⭐ 20,936 | 🐛 3,231 | 🌐 Go | 📅 2026-09-17 is a modern security gateway for remotely accessing into Clusters of Linux servers via SSH or SSH-over-HTTPS in a browser or Kubernetes clusters.
...
[BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,764 | 🐛 68 | 🌐 Go | 📅 2026-09-21 is an embeddable, persistent and fast key-value (KV) database written in pure Go. It is the underlying database for [Dgraph](https://dgraph.io/), a fast, distributed graph database. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,480 | 🐛 1,118 | 🌐 CMake | 📅 2026-09-22 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Play Framework](https://github.com/playframework/playframework) ⭐ 12,617 | 🐛 493 | 🌐 Scala | 📅 2026-09-22 is a web framework combines productivity and performance making it easy to build scalable web applications with Java and Scala.

[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,299 | 🐛 1,849 | 🌐 Scala | 📅 2026-09-22 is a research compiler that will become Scala 3.
...
[Groovy Language Server](https://github.com/prominic/groovy-language-server) ⭐ 234 | 🐛 26 | 🌐 Java | 📅 2026-05-19 is a [language server](https://microsoft.github.io/language-server-protocol/) protocol for [Groovy](https://groovy-lang.org/).
...
[Spock](https://github.com/spockframework/spock) ⭐ 3,630 | 🐛 211 | 🌐 Java | 📅 2026-09-17 is a BDD-style developer testing and specification framework for Java and Groovy applications.
...
[Groovy-Eclipse](https://github.com/groovy/groovy-eclipse) ⭐ 681 | 🐛 62 | 🌐 Java | 📅 2026-09-21 is a project that provides Eclipse and Maven tooling support for the Apache Groovy programming language.
...
[Reagent](https://github.com/reagent-project/reagent) ⭐ 4,888 | 🐛 27 | 🌐 Clojure | 📅 2026-08-19 is a minimalistic [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,391 | 🐛 8 | 🌐 Clojure | 📅 2026-09-20 interface to [React](https://facebook.github.io/react/).
...
[Arcadia](https://github.com/arcadia-unity/Arcadia) ⭐ 1,689 | 🐛 55 | 🌐 Clojure | 📅 2023-02-15 is an integration of the Clojure Programming Language with the Unity 3D game engine.
...
[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,136 | 🐛 232 | 🌐 C++ | 📅 2026-09-21 is a suite of tools for WebAssembly.

[Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,632 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-22 is a compiler and toolchain infrastructure library for WebAssembly, written in C++. It aims to make [compiling to WebAssembly](https://github.com/WebAssembly/binaryen/wiki/Compiling-to-WebAssembly-with-Binaryen) ⭐ 8,632 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-22 easy, fast, and effective.
...
[AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,023 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-14 compiles a strict variant of TypeScript (JavaScript with types) to WebAssembly using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,632 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-22.

[TinyGo](https://tinygo.org/) is a Go compiler(based on LLVM) intended for use in small places such as microcontrollers, WebAssembly (Wasm), and command-line tools.

[Capstone](https://github.com/aquynh/capstone) ⭐ 9,032 | 🐛 355 | 🌐 C | 📅 2026-09-21 is a  disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
[WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,110 | 🐛 606 | 🌐 C | 📅 2026-09-22 is a standalone WebAssembly (WASM) runtime with a small footprint.

[Pion WebRTC](https://github.com/pion/webrtc) ⭐ 16,787 | 🐛 122 | 🌐 Go | 📅 2026-09-21 is a pure Go implementation of [WebRTC API](https://w3c.github.io/webrtc-pc/).

[vim.wasm](http://rhysd.github.io/vim.wasm) is a port of the Vim ediotr to Webassemly using  [Emscripten](http://kripken.github.io/emscripten-site/) and [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,632 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-22.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,780 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-22, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 27,019 | 🐛 114 | 🌐 Rust | 📅 2026-09-22 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 329 | 🐛 81 | 🌐 C | 📅 2026-09-13 and supports [explainshell](https://explainshell.com/) integration.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,294 | 🐛 7,904 | 🌐 C# | 📅 2026-09-22 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,118 | 🐛 173 | 🌐 C# | 📅 2026-09-22 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,318 | 🐛 4,012 | 🌐 C# | 📅 2026-09-22 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Analysis server](https://github.com/dart-lang/sdk/tree/master/pkg/analysis_server) ⭐ 11,287 | 🐛 8,403 | 🌐 Dart | 📅 2026-09-22 is designed to provide on-going analysis of one or more code bases as those code bases are changing.
...
[Firebase iOS](https://github.com/firebase/firebase-ios-sdk) ⭐ 6,664 | 🐛 435 | 🌐 C++ | 📅 2026-09-22 is all the Apple platform Firebase SDK source except FirebaseAnalytics, FirebasePerformance, and FirebaseML.
...
[Reactive Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,309 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-22 is a well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS & Android platforms for all Firebase services.

[React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 128 | 🌐 JavaScript | 📅 2026-09-19 is Redux bindings for Firebase that includes React Hooks and Higher Order Components.

[FirebaseUI](https://github.com/firebase/FirebaseUI-Android) ⭐ 4,806 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-22 is an open-source library for Android that allows you to quickly connect common UI elements to Firebase APIs.
...
[ReactFire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,570 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-21 is a project that provides Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,164 | 🐛 694 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Qaterial](https://github.com/OlivierLDff/Qaterial) ⭐ 359 | 🐛 28 | 🌐 QML | 📅 2026-05-03 is a collection of Material Components to build faster UI using Qml.
...
[React Router Bootstrap](https://github.com/react-bootstrap/react-router-bootstrap) ⭐ 1,675 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-18 is a package that provides integration between [React Router](https://github.com/reactjs/react-router) ⭐ 56,583 | 🐛 178 | 🌐 TypeScript | 📅 2026-09-22 v4 and React Bootstrap.
...
[CubDB](https://github.com/lucaong/cubdb) ⭐ 656 | 🐛 16 | 🌐 Elixir | 📅 2024-10-02 is an embedded key-value database written in the Elixir language. It runs locally, it is schema-less, and backed by a single file.
...
[Credo](https://github.com/rrrene/credo) ⭐ 5,222 | 🐛 42 | 🌐 Elixir | 📅 2026-08-26 is a static code analysis tool for the Elixir language with a focus on code consistency and teaching.

[Absinthe](https://github.com/absinthe-graphql/absinthe) ⭐ 4,402 | 🐛 70 | 🌐 Elixir | 📅 2026-09-02 is a GraphQL toolkit for Elixir.

[Guardian](https://github.com/ueberauth/guardian) ⭐ 3,514 | 🐛 1 | 🌐 Elixir | 📅 2026-08-18 is a token based authentication library for use with Elixir applications.
...
[Timex](https://github.com/bitwalker/timex) ⭐ 1,806 | 🐛 72 | 🌐 Elixir | 📅 2025-06-14 is a complete date/time library for Elixir projects.

[Ueberauth](https://github.com/ueberauth/ueberauth) ⭐ 1,716 | 🐛 30 | 🌐 Elixir | 📅 2026-09-18 is an Elixir Authentication System for Plug-based Web Applications.
...
[Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,521 | 🐛 65 | 🌐 Erlang | 📅 2026-09-16 is a small, fast and modern HTTP server for Erlang/OTP.
...
[Hackney](https://github.com/benoitc/hackney) ⭐ 1,417 | 🐛 17 | 🌐 Erlang | 📅 2026-09-21 is a simple HTTP client in Erlang.
...
[Apache APISIX](https://github.com/apache/apisix) ⭐ 17,155 | 🐛 239 | 🌐 Lua | 📅 2026-09-22 is a dynamic, real-time, high-performance API gateway, based on the Nginx library and etcd.
...
[Sequeler](https://github.com/Alecaddd/sequeler) ⭐ 843 | 🐛 67 | 🌐 Vala | 📅 2026-09-07 is a native Linux SQL client built in Vala and Gtk. It allows you to connect to your local and remote databases, write SQL in a handy text editor with language recognition, and visualize SELECT results in a Gtk.Grid Widget.

[Code](https://github.com/elementary/code) ⭐ 523 | 🐛 154 | 🌐 Vala | 📅 2026-09-22 is a fast and lightweight code editor designed for elementary OS.

[Granite](https://github.com/elementary/granite) ⭐ 330 | 🐛 134 | 🌐 Vala | 📅 2026-09-22 is a companion library for GTK+ and GLib. Also, it provides complex widgets and convenience functions designed for use in apps built for elementary OS.
...
[Haskell Dockerfile Linter](https://github.com/hadolint/hadolint) ⭐ 12,425 | 🐛 207 | 🌐 Haskell | 📅 2026-08-24 is a smarter Dockerfile linter that helps you build [best practice](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices) Docker images.

[ShellCheck](https://www.shellcheck.net/) is a shell script static analysis tool.

[Haskell for Visual Studio Code](https://github.com/haskell/vscode-haskell) ⭐ 597 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-13 is an extension adds language support for Haskell, powered by the [Haskell Language Server](https://github.com/haskell/haskell-language-server) ⭐ 2,959 | 🐛 563 | 🌐 Haskell | 📅 2026-09-22.
...
[CodeWorld](https://github.com/google/codeworld) ⭐ 1,269 | 🐛 312 | 🌐 Haskell | 📅 2026-01-25 is an educational environment using Haskell. It provides a simple mathematical model for geometric figures, animations, and interactive and multi-player games.
...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,561 | 🐛 134 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,963 | 🐛 1,770 | 🌐 C++ | 📅 2026-09-22 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more.

[PowerShell Core](https://github.com/PowerShell/PowerShell) ⭐ 55,489 | 🐛 1,608 | 🌐 C# | 📅 2026-09-22 is a cross-platform (Windows, Linux, and macOS) automation and configuration tool/framework that works well with your existing tools and is optimized for dealing with structured data (e.g. JSON, CSV, XML, etc.), REST APIs, and object models. It includes a command-line shell, an associated scripting language and a framework for processing cmdlets.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,500 | 🐛 1,000 | 🌐 C++ | 📅 2026-09-22 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 18,098 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,715 | 🐛 663 | 🌐 TypeScript | 📅 2026-06-18 is a library which was made for and is used by ethers.io. It is designed to make it easier to write client-side JavaScript based wallets, keeping the private key on the owner’s machine at all times.
...
[audio-visualizer-python](https://github.com/djfun/audio-visualizer-python) ⭐ 267 | 🐛 5 | 🌐 Python | 📅 2026-09-17 is a little GUI tool which creates an audio visualization video from an input audio. You can also give it a background image and set a title text.
...
[UniversalSoundboard](https://github.com/dav-apps/UniversalSoundboard) ⭐ 18 | 🐛 8 | 🌐 C# | 📅 2026-09-16 is a customizable soundboard for your Windows 10 device. Add your sounds or music and sort them in categories. You can also add images to your favourite sounds.
...
[Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,424 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 is a graphical processor simulator and assembly editor for the RISC-V instruction set architecture(ISA).

[FireSim](https://github.com/firesim/firesim) ⭐ 1,043 | 🐛 239 | 🌐 Scala | 📅 2026-09-10 is an easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
[DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,610 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04 is an open souce RISC-V cpu core implemented in Verilog from scratch.
...
[AWS SAM CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,734 | 🐛 541 | 🌐 Python | 📅 2026-09-22 is a CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
[Kong](https://github.com/Kong/kong) ⭐ 44,175 | 🐛 203 | 🌐 Lua | 📅 2026-09-22 is a Cloud-Native API Gateway.

[faasd](https://openfaas.com/blog/introducing-faasd/) is a project similar to [OpenFaaS](https://github.com/openfaas/), but without the cost and complexity of Kubernetes. It runs on a single host with very modest requirements, making it fast and easy to manage. Under the hood it uses [containerd](https://containerd.io/) and [Container Networking Interface (CNI)](https://github.com/containernetworking/cni) ⭐ 6,121 | 🐛 155 | 🌐 Go | 📅 2026-09-14 along with the same core OpenFaaS components from the main project.

[Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,874 | 🐛 98 | 🌐 Rust | 📅 2026-09-22 is an open source virtualization technology that is purpose-built for creating and managing secure, multi-tenant container and function-based services that provide serverless operational models.

[Gloo Edge](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,870 | 🌐 Go | 📅 2026-09-19 is a feature-rich, Kubernetes-native ingress controller, and next-generation API gateway built on [Envoy](https://envoy.com/features/saas/).
...
[TiDB](https://github.com/pingcap/tidb) ⭐ 40,572 | 🐛 7,097 | 🌐 Go | 📅 2026-09-22 is an open-source NewSQL database that supports Hybrid Transactional and Analytical Processing (HTAP) workloads.

[Prisma](https://www.prisma.io) is open source ORM for Node.js, TypeScript, PostgreSQL, MySQL and SQLite.

[Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,819 | 🐛 686 | 🌐 Python | 📅 2023-03-23 is a tool for Serverless Python.
...
[KEDA](https://github.com/kedacore/keda) ⭐ 10,546 | 🐛 240 | 🌐 Go | 📅 2026-09-22 is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
[Midway Serverless](https://github.com/midwayjs/midway) ⭐ 7,744 | 🐛 116 | 🌐 TypeScript | 📅 2026-09-19 is a serverless framework used to build Node.js cloud functions. Helps you significantly reduce maintenance costs and focus more on product development in the Cloud-Native environment.

[Micronaut](https://micronaut.io/) is a modern, JVM-based, full stack Java framework designed for building modular, easily testable JVM applications with support for Java, Kotlin and the Groovy language.

[Cube.js](https://github.com/cube-js/cube.js) ⭐ 20,890 | 🐛 1,190 | 🌐 Rust | 📅 2026-09-22 is an open-source analytical API platform. It is primarily used to build internal business intelligence tools or add customer-facing analytics to existing applications.
...
[Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,067 | 🐛 126 | 🌐 Python | 📅 2026-09-22 is a Python library for writing, manipulating, and optimizing Noisy Intermediate Scale Quantum (NISQ) circuits and running them against quantum computers and simulators.

[PyQuil](https://github.com/rigetti/pyquil) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-09-22 is a Python library for quantum programming using [Quil](https://arxiv.org/abs/1608.03355), the quantum instruction language developed at [Rigetti Computing](https://www.rigetti.com/).

[OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,736 | 🐛 33 | 🌐 Python | 📅 2026-09-21 is an open source library for compiling and analyzing quantum algorithms to simulate fermionic systems, including quantum chemistry.

[QuTiP](https://github.com/qutip/qutip) ⭐ 2,077 | 🐛 114 | 🌐 Python | 📅 2026-09-21 is open-source software for simulating the dynamics of closed and open quantum systems. The QuTiP library uses the excellent Numpy, Scipy, and Cython packages as the numerical backend, and graphical output is provided by Matplotlib.
